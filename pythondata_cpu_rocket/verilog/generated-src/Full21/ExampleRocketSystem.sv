...
module ExampleRocketSystem(
  ...
  wire        _tileHartIdNexusNode_auto_out_1;	// src/main/scala/subsystem/HasTiles.scala:156:39
  wire        _tileHartIdNexusNode_auto_out_0;	// src/main/scala/subsystem/HasTiles.scala:156:39
  ...
  TLInterconnectCoupler_6 subsystem_fbus_coupler_from_port_named_slave_port_axi4 (	// src/main/scala/diplomacy/LazyModule.scala:501:27
    .clock                                        (subsystem_fbus_childClock),	// src/main/scala/diplomacy/LazyModule.scala:419:31
    .reset                                        (subsystem_fbus_childReset),	// src/main/scala/diplomacy/LazyModule.scala:421:31
  ...
  IntXbar_3 xbar (	// src/main/scala/interrupts/Xbar.scala:50:26
  ...
  IntXbar_3 xbar_2 (	// src/main/scala/interrupts/Xbar.scala:50:26
  ...
  BundleBridgeNexus_24 tileHartIdNexusNode (	// src/main/scala/subsystem/HasTiles.scala:156:39
  ...
  IntSyncCrossingSource_9 intsource (	// src/main/scala/interrupts/Crossing.scala:28:31
    .clock           (clock),
    .reset           (reset),
  ...
  IntSyncCrossingSource_9 intsource_3 (	// src/main/scala/interrupts/Crossing.scala:28:31
    .clock           (clock),
    .reset           (reset),
  ...
  IntSyncCrossingSource_15 intsource_6 (	// src/main/scala/interrupts/Crossing.scala:28:31
    .clock           (clock),
    .reset           (reset),
