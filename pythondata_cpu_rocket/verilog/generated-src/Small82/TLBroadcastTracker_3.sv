...
module TLBroadcastTracker_3(
  ...
  wire [7:0]   io_probe_bits_cacheOH = 8'hFF;
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_0)	// src/main/scala/tilelink/Broadcast.scala:468:22
      ...
      count <= 4'h1;	// src/main/scala/tilelink/Broadcast.scala:434:20
    if (io_probe_valid_0)
      cacheOH <= 8'hFF;	// src/main/scala/tilelink/Broadcast.scala:435:20
    else
