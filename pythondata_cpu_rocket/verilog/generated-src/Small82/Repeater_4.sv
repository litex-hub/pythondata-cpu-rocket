  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_source = _RANDOM[2'h0][15:10];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_address = _RANDOM[2'h0][27:16];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_mask = {_RANDOM[2'h0][31:28], _RANDOM[2'h1][3:0]};	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_data = {_RANDOM[2'h1][31:4], _RANDOM[2'h2], _RANDOM[2'h3][3:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_corrupt = _RANDOM[2'h3][4];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
