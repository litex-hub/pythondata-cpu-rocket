...
module BreakpointUnit(
  ...
  assign r =
    ...
    & (io_bp_0_control_tmatch_0[1]
         ...
         : {_w_T_5[32:4],
            _w_T_5[3:0]
              | {r_hi, r_lo}} == {_x_T_15[32:4], _x_T_15[3:0] | {r_hi_1, r_lo_1}});	// src/main/scala/rocket/Breakpoint.scala:30:50, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :106:{16,32,58}, src/main/scala/util/package.scala:37:27
  ...
  assign w =
    ...
    & (io_bp_0_control_tmatch_0[1]
         ...
         : {_w_T_5[32:4],
            _w_T_5[3:0]
              | {w_hi, w_lo}} == {_x_T_15[32:4], _x_T_15[3:0] | {w_hi_1, w_lo_1}});	// src/main/scala/rocket/Breakpoint.scala:30:50, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :107:{16,32,58}, src/main/scala/util/package.scala:37:27
  ...
  assign x =
    ...
    & (io_bp_0_control_tmatch_0[1]
         ...
         : {_x_T_5[32:4],
            _x_T_5[3:0]
              | {x_hi, x_lo}} == {_x_T_15[32:4], _x_T_15[3:0] | {x_hi_1, x_lo_1}});	// src/main/scala/rocket/Breakpoint.scala:30:50, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :108:{16,32,58}, src/main/scala/util/package.scala:37:27
  wire        io_bpwatch_0_ivalid_0_0 = x;	// src/main/scala/rocket/Breakpoint.scala:108:58
  wire [2:0]  io_bpwatch_0_action = {2'h0, io_bp_0_control_action_0};	// src/main/scala/rocket/Breakpoint.scala:112:16
