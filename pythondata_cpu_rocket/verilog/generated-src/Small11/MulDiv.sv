...
module MulDiv(
  ...
  wire [128:0] eOutRes = mulReg >> 6'h0 - count[5:0];	// src/main/scala/rocket/Multiplier.scala:51:18, :104:21, :116:{27,38}
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_5) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
      ...
      count <= {1'h0, cmdMul & ~io_req_bits_dw_0, 5'h0};	// src/main/scala/rocket/Multiplier.scala:51:18, :72:107, :75:60, :165:{11,46}
