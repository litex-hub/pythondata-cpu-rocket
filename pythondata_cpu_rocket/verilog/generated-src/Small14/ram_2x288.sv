...
module ram_2x288(	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  input          R0_addr,
                 R0_en,
                 R0_clk,
  ...
  reg [287:0] Memory[0:1];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 288'bx;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
