...
module Queue_135(
  ...
  wire [31:0]  io_enq_bits_strb_0 = io_enq_bits_strb;
  ...
  reg  [288:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [255:0] io_deq_bits_data_0 = empty ? io_enq_bits_data_0 : ram[255:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [31:0]  io_deq_bits_strb_0 = empty ? io_enq_bits_strb_0 : ram[287:256];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire         io_deq_bits_last_0 = empty ? io_enq_bits_last_0 : ram[288];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram =
          {_RANDOM[4'h0][31:1],
           ...
           _RANDOM[4'h7],
           _RANDOM[4'h8],
           _RANDOM[4'h9][1:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        maybe_full = _RANDOM[4'h0][0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
