...
module ExampleRocketSystem(
  ...
  IntSyncCrossingSource_9 intsource_2 (	// src/main/scala/interrupts/Crossing.scala:28:31
    .clock           (clock),
    .reset           (reset),
  ...
  IntSyncCrossingSource_13 intsource_4 (	// src/main/scala/interrupts/Crossing.scala:28:31
    .clock           (clock),
    .reset           (reset),
