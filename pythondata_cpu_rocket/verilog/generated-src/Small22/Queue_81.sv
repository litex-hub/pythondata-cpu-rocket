...
module Queue_81(
  ...
  wire [127:0] io_deq_bits_data_0 = ram[127:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [15:0]  io_deq_bits_strb_0 = ram[143:128];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_last_0 = ram[144];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
