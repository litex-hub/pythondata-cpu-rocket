...
module MulAddRecFNToRaw_preMul_1(
  ...
  wire         isMinCAlign = rawA_isZero | rawB_isZero | $signed(sNatCAlignDist) < 14'sh0;	// hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:105:42, :107:{35,50,69}, hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:55:23
  ...
  wire         io_toPostMul_isSigNaNAny_0 =
    ...
    & ~(rawC_sig[51]);	// hardfloat/hardfloat/src/main/scala/MulAddRecFN.scala:145:{32,58}, hardfloat/hardfloat/src/main/scala/common.scala:82:{46,49,56}, hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:55:23
