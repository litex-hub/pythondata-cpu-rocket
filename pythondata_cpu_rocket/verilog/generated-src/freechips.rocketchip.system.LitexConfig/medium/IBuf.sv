...
module IBuf(
  ...
  wire         io_imem_bits_btb_entry_0 = io_imem_bits_btb_entry;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        buf_btb_entry = _RANDOM[3'h1][14];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_btb_bht_history = _RANDOM[3'h1][22:15];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_btb_bht_value = _RANDOM[3'h1][23];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_pc = {_RANDOM[3'h1][31:24], _RANDOM[3'h2]};	// src/main/scala/rocket/IBuf.scala:35:16
        buf_data = _RANDOM[3'h3];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_mask = _RANDOM[3'h4][1:0];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_xcpt_pf_inst = _RANDOM[3'h4][2];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_xcpt_gf_inst = _RANDOM[3'h4][3];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_xcpt_ae_inst = _RANDOM[3'h4][4];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_replay = _RANDOM[3'h4][5];	// src/main/scala/rocket/IBuf.scala:35:16
        ibufBTBResp_cfiType = _RANDOM[3'h4][7:6];	// src/main/scala/rocket/IBuf.scala:35:16, :36:24
        ibufBTBResp_taken = _RANDOM[3'h4][8];	// src/main/scala/rocket/IBuf.scala:35:16, :36:24
        ibufBTBResp_mask = _RANDOM[3'h4][10:9];	// src/main/scala/rocket/IBuf.scala:35:16, :36:24
        ibufBTBResp_bridx = _RANDOM[3'h4][11];	// src/main/scala/rocket/IBuf.scala:35:16, :36:24
        ibufBTBResp_target = {_RANDOM[3'h4][31:12], _RANDOM[3'h5][18:0]};	// src/main/scala/rocket/IBuf.scala:35:16, :36:24
        ibufBTBResp_entry = _RANDOM[3'h5][19];	// src/main/scala/rocket/IBuf.scala:36:24
        ibufBTBResp_bht_history = _RANDOM[3'h5][27:20];	// src/main/scala/rocket/IBuf.scala:36:24
        ibufBTBResp_bht_value = _RANDOM[3'h5][28];	// src/main/scala/rocket/IBuf.scala:36:24
      `endif // RANDOMIZE_REG_INIT
    end // initial
