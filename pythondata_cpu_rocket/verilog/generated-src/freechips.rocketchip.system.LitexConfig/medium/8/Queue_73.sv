...
module Queue_73(
  ...
  input  [7:0] io_enq_bits_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  input  [3:0] io_enq_bits_extra_id,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [7:0] io_deq_bits_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  output [3:0] io_deq_bits_extra_id	// src/main/scala/chisel3/util/Decoupled.scala:273:14
);

  wire [15:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_enq_valid_0 = io_enq_valid;
  wire [3:0]  io_enq_bits_tl_state_size_0 = io_enq_bits_tl_state_size;
  wire [7:0]  io_enq_bits_tl_state_source_0 = io_enq_bits_tl_state_source;
  wire [3:0]  io_enq_bits_extra_id_0 = io_enq_bits_extra_id;
  ...
  wire [7:0]  io_deq_bits_tl_state_source_0 = _ram_ext_R0_data[11:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_extra_id_0 = _ram_ext_R0_data[15:12];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [4:0]  io_count = {maybe_full & ptr_match, ptr_diff};	// src/main/scala/chisel3/util/Decoupled.scala:277:27, :278:33, :327:32, :330:{32,62}
  ...
  ram_16x16 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
