...
module Queue_13(
  ...
  input  [5:0] io_enq_bits_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [5:0] io_deq_bits_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  output       io_deq_bits_extra_id	// src/main/scala/chisel3/util/Decoupled.scala:273:14
);

  wire [10:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_enq_valid_0 = io_enq_valid;
  wire [3:0]  io_enq_bits_tl_state_size_0 = io_enq_bits_tl_state_size;
  wire [5:0]  io_enq_bits_tl_state_source_0 = io_enq_bits_tl_state_source;
  wire        io_enq_bits_extra_id_0 = io_enq_bits_extra_id;
  ...
  wire [5:0]  io_deq_bits_tl_state_source_0 = _ram_ext_R0_data[9:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_extra_id_0 = _ram_ext_R0_data[10];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [3:0]  io_count =
    ptr_match
      ...
      : deq_ptr_value > enq_ptr_value ? ptr_diff - 4'h7 : ptr_diff;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:277:27, :278:33, :327:32, :332:20, :334:10, :335:{10,25,57}
  ...
  ram_9x11 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
