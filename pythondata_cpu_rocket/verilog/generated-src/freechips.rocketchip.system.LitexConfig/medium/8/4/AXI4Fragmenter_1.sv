...
module AXI4Fragmenter_1(
  ...
  wire [7:0]       auto_out_aw_bits_len = 8'h0;	// src/main/scala/amba/axi4/Fragmenter.scala:62:23, :93:46, :101:25, src/main/scala/diplomacy/LazyModule.scala:367:18, src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [7:0]       auto_out_ar_bits_len = 8'h0;	// src/main/scala/amba/axi4/Fragmenter.scala:62:23, :93:46, :101:25, src/main/scala/diplomacy/LazyModule.scala:367:18, src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [255:0]     in_w_bits_data;	// src/main/scala/chisel3/util/Decoupled.scala:415:19
  wire [255:0]     auto_out_w_bits_data_0 = nodeOut_w_bits_data;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [31:0]      in_w_bits_strb;	// src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  wire [4:0]       lo = addr[4:0];	// src/main/scala/amba/axi4/Fragmenter.scala:69:23, :71:49
  wire [7:0]       alignment = addr[12:5];	// src/main/scala/amba/axi4/Fragmenter.scala:69:23, :73:29
  ...
  wire             narrow = irr_bits_size != 3'h5;	// src/main/scala/amba/axi4/Fragmenter.scala:97:34, src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  wire [11:0]      _out_bits_addr_T_2 = 12'h1F << irr_bits_size;	// src/main/scala/chisel3/util/Decoupled.scala:415:19, src/main/scala/util/package.scala:235:71
  assign in_ar_bits_addr =
    ~{_out_bits_addr_T[31:5], _out_bits_addr_T[4:0] | ~(_out_bits_addr_T_2[4:0])};	// src/main/scala/amba/axi4/Fragmenter.scala:62:23, :126:{26,28,34}, src/main/scala/util/package.scala:235:{46,71,76}
  ...
  wire [4:0]       lo_1 = addr_1[4:0];	// src/main/scala/amba/axi4/Fragmenter.scala:69:23, :71:49
  wire [7:0]       alignment_1 = addr_1[12:5];	// src/main/scala/amba/axi4/Fragmenter.scala:69:23, :73:29
  ...
  wire             narrow_1 = irr_1_bits_size != 3'h5;	// src/main/scala/amba/axi4/Fragmenter.scala:97:34, src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  wire [11:0]      _out_bits_addr_T_9 = 12'h1F << irr_1_bits_size;	// src/main/scala/chisel3/util/Decoupled.scala:415:19, src/main/scala/util/package.scala:235:71
  assign in_aw_bits_addr =
    ~{_out_bits_addr_T_7[31:5], _out_bits_addr_T_7[4:0] | ~(_out_bits_addr_T_9[4:0])};	// src/main/scala/amba/axi4/Fragmenter.scala:62:23, :126:{26,28,34}, src/main/scala/util/package.scala:235:{46,71,76}
  ...
  Queue_159 deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_159 deq_q_1 (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_161 in_w_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
