...
module Queue_70(
  ...
  reg  [102:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [5:0]   io_deq_bits_source_0 = ram[15:10];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [13:0]  io_deq_bits_address = ram[29:16];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]   io_deq_bits_mask = ram[37:30];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0]  io_deq_bits_data = ram[101:38];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_corrupt = ram[102];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][7:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
