...
module ram_9x11(	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  input  [3:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [10:0] R0_data,
  ...
  reg [10:0] Memory[0:8];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:274:95
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        for (logic [3:0] i = 4'h0; i < 4'h9; i += 4'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[10:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
