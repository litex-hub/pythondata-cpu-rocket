...
module ShiftQueue(
  ...
  wire        io_enq_bits_btb_taken = 1'h0;	// src/main/scala/util/ShiftQueue.scala:17:14, :27:57
  wire        io_enq_bits_xcpt_gf_inst = 1'h0;	// src/main/scala/util/ShiftQueue.scala:17:14, :27:57
  ...
  wire [2:0]  io_count =
    ...
    + {1'h0, {1'h0, io_mask_0[2]} + {1'h0, io_mask_0[3]} + {1'h0, io_mask_0[4]}};	// src/main/scala/util/ShiftQueue.scala:17:14, :27:57, :54:23
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        elts_0_btb_entry = _RANDOM[5'h1][18];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_0_btb_bht_history = _RANDOM[5'h1][26:19];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_0_btb_bht_value = _RANDOM[5'h1][27];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_0_pc = {_RANDOM[5'h1][31:28], _RANDOM[5'h2], _RANDOM[5'h3][3:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_0_data = {_RANDOM[5'h3][31:4], _RANDOM[5'h4][3:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_0_mask = _RANDOM[5'h4][5:4];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_0_xcpt_pf_inst = _RANDOM[5'h4][6];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_0_xcpt_gf_inst = _RANDOM[5'h4][7];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_0_xcpt_ae_inst = _RANDOM[5'h4][8];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_0_replay = _RANDOM[5'h4][9];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_btb_cfiType = _RANDOM[5'h4][11:10];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_btb_taken = _RANDOM[5'h4][12];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_btb_mask = _RANDOM[5'h4][14:13];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_btb_bridx = _RANDOM[5'h4][15];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_btb_target = {_RANDOM[5'h4][31:16], _RANDOM[5'h5][22:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_btb_entry = _RANDOM[5'h5][23];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_btb_bht_history = _RANDOM[5'h5][31:24];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_btb_bht_value = _RANDOM[5'h6][0];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_pc = {_RANDOM[5'h6][31:1], _RANDOM[5'h7][8:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_data = {_RANDOM[5'h7][31:9], _RANDOM[5'h8][8:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_mask = _RANDOM[5'h8][10:9];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_xcpt_pf_inst = _RANDOM[5'h8][11];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_xcpt_gf_inst = _RANDOM[5'h8][12];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_xcpt_ae_inst = _RANDOM[5'h8][13];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_1_replay = _RANDOM[5'h8][14];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_btb_cfiType = _RANDOM[5'h8][16:15];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_btb_taken = _RANDOM[5'h8][17];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_btb_mask = _RANDOM[5'h8][19:18];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_btb_bridx = _RANDOM[5'h8][20];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_btb_target = {_RANDOM[5'h8][31:21], _RANDOM[5'h9][27:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_btb_entry = _RANDOM[5'h9][28];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_btb_bht_history = {_RANDOM[5'h9][31:29], _RANDOM[5'hA][4:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_btb_bht_value = _RANDOM[5'hA][5];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_pc = {_RANDOM[5'hA][31:6], _RANDOM[5'hB][13:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_data = {_RANDOM[5'hB][31:14], _RANDOM[5'hC][13:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_mask = _RANDOM[5'hC][15:14];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_xcpt_pf_inst = _RANDOM[5'hC][16];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_xcpt_gf_inst = _RANDOM[5'hC][17];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_xcpt_ae_inst = _RANDOM[5'hC][18];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_2_replay = _RANDOM[5'hC][19];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_btb_cfiType = _RANDOM[5'hC][21:20];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_btb_taken = _RANDOM[5'hC][22];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_btb_mask = _RANDOM[5'hC][24:23];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_btb_bridx = _RANDOM[5'hC][25];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_btb_target = {_RANDOM[5'hC][31:26], _RANDOM[5'hD], _RANDOM[5'hE][0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_btb_entry = _RANDOM[5'hE][1];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_btb_bht_history = _RANDOM[5'hE][9:2];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_btb_bht_value = _RANDOM[5'hE][10];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_pc = {_RANDOM[5'hE][31:11], _RANDOM[5'hF][18:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_data = {_RANDOM[5'hF][31:19], _RANDOM[5'h10][18:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_mask = _RANDOM[5'h10][20:19];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_xcpt_pf_inst = _RANDOM[5'h10][21];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_xcpt_gf_inst = _RANDOM[5'h10][22];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_xcpt_ae_inst = _RANDOM[5'h10][23];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_3_replay = _RANDOM[5'h10][24];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_btb_cfiType = _RANDOM[5'h10][26:25];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_btb_mask = _RANDOM[5'h10][29:28];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_btb_bridx = _RANDOM[5'h10][30];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_btb_target = {_RANDOM[5'h10][31], _RANDOM[5'h11], _RANDOM[5'h12][5:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_btb_entry = _RANDOM[5'h12][6];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_btb_bht_history = _RANDOM[5'h12][14:7];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_btb_bht_value = _RANDOM[5'h12][15];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_pc = {_RANDOM[5'h12][31:16], _RANDOM[5'h13][23:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_data = {_RANDOM[5'h13][31:24], _RANDOM[5'h14][23:0]};	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_mask = _RANDOM[5'h14][25:24];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_xcpt_pf_inst = _RANDOM[5'h14][26];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_xcpt_gf_inst = _RANDOM[5'h14][27];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_xcpt_ae_inst = _RANDOM[5'h14][28];	// src/main/scala/util/ShiftQueue.scala:22:25
        elts_4_replay = _RANDOM[5'h14][29];	// src/main/scala/util/ShiftQueue.scala:22:25
      `endif // RANDOMIZE_REG_INIT
    end // initial
