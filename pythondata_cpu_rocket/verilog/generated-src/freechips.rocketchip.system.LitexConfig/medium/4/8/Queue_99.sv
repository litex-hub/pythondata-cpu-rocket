...
module Queue_99(
  ...
  wire         io_enq_bits_last = 1'h1;	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :278:33
  wire         ptr_match = 1'h1;	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :278:33
  reg  [576:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [511:0] io_deq_bits_data_0 = ram[511:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0]  io_deq_bits_strb_0 = ram[575:512];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_last_0 = ram[576];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  always @(posedge clock) begin
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <= {1'h1, io_enq_bits_strb_0, io_enq_bits_data_0};	// src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :278:33
    if (reset)
