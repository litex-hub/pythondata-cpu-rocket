...
module AXI4Buffer_2(
  ...
  Queue_138 nodeOut_aw_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_138 nodeOut_ar_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_142 nodeIn_r_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                      (clock),
    .reset                      (reset),
