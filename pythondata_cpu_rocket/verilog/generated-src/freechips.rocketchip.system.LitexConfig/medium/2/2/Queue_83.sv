...
module Queue_83(
  ...
  wire [15:0]  io_enq_bits_mask_0 = io_enq_bits_mask;
  wire [127:0] io_enq_bits_data_0 = io_enq_bits_data;
  wire         io_deq_ready_0 = io_deq_ready;
  wire [15:0]  io_deq_bits_mask_0 = _ram_ext_R0_data[15:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [127:0] io_deq_bits_data_0 = _ram_ext_R0_data[143:16];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [2:0]   io_count = {maybe_full & ptr_match, ptr_diff};	// src/main/scala/chisel3/util/Decoupled.scala:277:27, :278:33, :327:32, :330:{32,62}
  ...
  ram_4x144 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
