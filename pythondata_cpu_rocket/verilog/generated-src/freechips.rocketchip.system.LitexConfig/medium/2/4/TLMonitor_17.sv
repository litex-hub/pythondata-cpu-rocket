  ...
  `ifndef SYNTHESIS	// src/main/scala/tilelink/Monitor.scala:42:11
    always @(posedge clock) begin	// src/main/scala/tilelink/Monitor.scala:42:11
      ...
      automatic logic            _GEN_17 =
        (_source_ok_T_12 & _GEN_16 | _source_ok_T_15 & _GEN_16)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inflight_sizes =
          {_RANDOM[5'h5][31:18], _RANDOM[5'h6], _RANDOM[5'h7], _RANDOM[5'h8][13:0]};	// src/main/scala/tilelink/Monitor.scala:613:35, :615:33
        a_first_counter_1 = _RANDOM[5'h8][16:14];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/Monitor.scala:615:33
        d_first_counter_1 = _RANDOM[5'h8][19:17];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/Monitor.scala:615:33
        watchdog = {_RANDOM[5'h8][31:20], _RANDOM[5'h9][19:0]};	// src/main/scala/tilelink/Monitor.scala:615:33, :706:27
        inflight_1 = {_RANDOM[5'h9][31:20], _RANDOM[5'hA][10:0]};	// src/main/scala/tilelink/Monitor.scala:706:27, :723:35
        inflight_opcodes_1 =
          {_RANDOM[5'hA][31:11], _RANDOM[5'hB], _RANDOM[5'hC], _RANDOM[5'hD][6:0]};	// src/main/scala/tilelink/Monitor.scala:723:35, :724:35
        inflight_sizes_1 =
          {_RANDOM[5'hD][31:7], _RANDOM[5'hE], _RANDOM[5'hF], _RANDOM[5'h10][2:0]};	// src/main/scala/tilelink/Monitor.scala:724:35, :725:35
        d_first_counter_2 = _RANDOM[5'h10][8:6];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/Monitor.scala:725:35
        watchdog_1 = {_RANDOM[5'h10][31:9], _RANDOM[5'h11][8:0]};	// src/main/scala/tilelink/Monitor.scala:725:35, :815:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
