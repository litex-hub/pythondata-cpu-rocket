...
module RoundAnyRawFNToRecFN_3(
  ...
  wire        io_infiniteExc = 1'h0;	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:57:16
  wire        io_detectTininess = 1'h1;	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:57:16
       ...
       ? (roundMask_msb_1
            ...
            : {22'h0,
               roundMask_msb_3
                 ...
                 : 3'h0})
       : 25'h0,
     2'h3};	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:57:16, :158:42, hardfloat/hardfloat/src/main/scala/primitives.scala:58:25, :62:24, :67:24, :68:58, :73:{17,21,32}, :76:56, :77:20, :78:22
  wire [26:0] shiftedRoundMask = {1'h0, roundMask[26:1]};	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:57:16, :158:42, :161:53
  ...
  wire [25:0] roundedSig =
    roundIncr
      ...
      : {1'h0, adjustedSig[26:2] & ~(roundMask[26:2])}
        | (roundingMode_odd & anyRound ? roundPosMask[26:1] : 26'h0);	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:57:16, :89:53, :94:53, :115:66, :158:42, :162:46, :163:56, :164:62, :165:36, :169:31, :172:16, :173:{32,49,57}, :174:{21,25,64}, :175:30, :176:35, :179:{30,32,43,47}, :180:{24,42,67}
  ...
  wire [8:0]  expOut =
    ...
    | (isNaNOut ? 9'h1C0 : 9'h0);	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:57:16, :121:31, :124:37, :158:42, :234:34, :244:45, :245:39, :247:32, :252:{14,18,32}, :256:{14,18}, :257:19, :260:{14,18}, :263:17, :264:{14,18}, :268:16, :272:16, :276:{16,73}, :277:16
  wire [22:0] fractOut =
  ...
  wire [4:0]  io_exceptionFlags_0 = {io_invalidExc_0, 1'h0, overflow, underflow, inexact};	// hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:57:16, :237:32, :238:32, :239:28, :287:66
