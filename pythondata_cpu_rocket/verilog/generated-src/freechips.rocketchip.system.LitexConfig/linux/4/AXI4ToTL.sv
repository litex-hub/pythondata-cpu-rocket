...
module AXI4ToTL(
  ...
  wire        w_ok =
    ...
    & (nodeIn_aw_bits_addr[31:12] == 20'h0
       ...
       | nodeIn_aw_bits_addr[31]) | _w_out_bits_legal_T_48
  ...
  wire        w_out_bits_legal =
    ...
    & ({w_addr[31:27], w_addr[25], w_addr[16], w_addr[13]} == 8'h0
       ...
       | {w_addr[31:28], ~(w_addr[27])} == 5'h0 | w_addr[31]) | _w_out_bits_legal_T_48
  ...
  Queue_53 nodeIn_r_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_54 q_b_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
