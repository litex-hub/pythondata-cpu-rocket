...
module Queue_101(
  ...
  input  [31:0]  io_enq_bits_mask,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [31:0]  io_deq_bits_mask,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  output [255:0] io_deq_bits_data	// src/main/scala/chisel3/util/Decoupled.scala:273:14
);

  wire [287:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_enq_valid_0 = io_enq_valid;
  wire [31:0]  io_enq_bits_mask_0 = io_enq_bits_mask;
  wire [255:0] io_enq_bits_data_0 = io_enq_bits_data;
  wire         io_deq_ready_0 = io_deq_ready;
  wire [31:0]  io_deq_bits_mask_0 = _ram_ext_R0_data[31:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [255:0] io_deq_bits_data_0 = _ram_ext_R0_data[287:32];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  ram_2x288 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:274:95
