...
module ram_16x16(	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  input  [3:0]  R0_addr,
  input         R0_en,
                R0_clk,
  output [15:0] R0_data,
  ...
  reg [15:0] Memory[0:15];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:274:95
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        for (logic [4:0] i = 5'h0; i < 5'h10; i += 5'h1) begin
          ...
          Memory[i[3:0]] = _RANDOM_MEM[15:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
