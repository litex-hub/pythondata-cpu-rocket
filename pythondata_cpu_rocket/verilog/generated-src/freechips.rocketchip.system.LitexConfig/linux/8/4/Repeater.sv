...
module Repeater(
  ...
  input  [255:0] io_enq_bits_data,	// src/main/scala/util/Repeater.scala:12:14
  ...
  output [255:0] io_deq_bits_data,	// src/main/scala/util/Repeater.scala:12:14
  ...
  wire [255:0] io_enq_bits_data_0 = io_enq_bits_data;
  ...
  reg  [5:0]   saved_source;	// src/main/scala/util/Repeater.scala:20:18
  reg  [1:0]   saved_sink;	// src/main/scala/util/Repeater.scala:20:18
  reg          saved_denied;	// src/main/scala/util/Repeater.scala:20:18
  reg  [255:0] saved_data;	// src/main/scala/util/Repeater.scala:20:18
  ...
  wire [5:0]   io_deq_bits_source_0 = full ? saved_source : io_enq_bits_source_0;	// src/main/scala/util/Repeater.scala:19:21, :20:18, :25:21
  ...
  wire [255:0] io_deq_bits_data_0 = full ? saved_data : io_enq_bits_data_0;	// src/main/scala/util/Repeater.scala:19:21, :20:18, :25:21
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        full = _RANDOM[4'h0][0];	// src/main/scala/util/Repeater.scala:19:21
        saved_opcode = _RANDOM[4'h0][3:1];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_param = _RANDOM[4'h0][5:4];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_size = _RANDOM[4'h0][8:6];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_source = _RANDOM[4'h0][14:9];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_sink = _RANDOM[4'h0][16:15];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_denied = _RANDOM[4'h0][17];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_data =
          {_RANDOM[4'h0][31:18],
           _RANDOM[4'h1],
           _RANDOM[4'h2],
           ...
           _RANDOM[4'h6],
           _RANDOM[4'h7],
           _RANDOM[4'h8][17:0]};	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_corrupt = _RANDOM[4'h8][18];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
