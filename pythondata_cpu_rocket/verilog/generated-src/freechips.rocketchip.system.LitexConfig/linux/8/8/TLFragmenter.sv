...
module TLFragmenter(
  ...
  output [9:0]  auto_out_a_bits_source,	// src/main/scala/diplomacy/LazyModule.scala:367:18
  ...
  input  [9:0]  auto_out_d_bits_source,	// src/main/scala/diplomacy/LazyModule.scala:367:18
  ...
  wire [5:0]  _repeater_io_deq_bits_source;	// src/main/scala/tilelink/Fragmenter.scala:264:30
  ...
  wire [9:0]  auto_out_d_bits_source_0 = auto_out_d_bits_source;
  ...
  wire [9:0]  nodeOut_a_bits_source;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [9:0]  nodeOut_d_bits_source = auto_out_d_bits_source_0;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [9:0]  auto_out_a_bits_source_0 = nodeOut_a_bits_source;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  assign nodeIn_d_bits_source = nodeOut_d_bits_source[9:4];	// src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17, src/main/scala/tilelink/Fragmenter.scala:228:47
  ...
  wire [6:0]  nodeOut_a_bits_source_hi = {_repeater_io_deq_bits_source, aToggle};	// src/main/scala/tilelink/Fragmenter.scala:264:30, :299:23, :307:33
