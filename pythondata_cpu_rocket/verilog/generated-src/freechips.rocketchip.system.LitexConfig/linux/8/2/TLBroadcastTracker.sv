...
module TLBroadcastTracker(
  ...
  input  [5:0]   io_in_a_bits_source,	// src/main/scala/tilelink/Broadcast.scala:401:14
  input  [31:0]  io_in_a_bits_address,	// src/main/scala/tilelink/Broadcast.scala:401:14
  input  [15:0]  io_in_a_bits_mask,	// src/main/scala/tilelink/Broadcast.scala:401:14
  input  [127:0] io_in_a_bits_data,	// src/main/scala/tilelink/Broadcast.scala:401:14
  ...
  output [7:0]   io_out_a_bits_source,	// src/main/scala/tilelink/Broadcast.scala:401:14
  output [31:0]  io_out_a_bits_address,	// src/main/scala/tilelink/Broadcast.scala:401:14
  output [15:0]  io_out_a_bits_mask,	// src/main/scala/tilelink/Broadcast.scala:401:14
  output [127:0] io_out_a_bits_data,	// src/main/scala/tilelink/Broadcast.scala:401:14
  input          io_probe_valid,	// src/main/scala/tilelink/Broadcast.scala:401:14
  input  [3:0]   io_probe_bits_count,	// src/main/scala/tilelink/Broadcast.scala:401:14
  ...
  output [5:0]   io_source,	// src/main/scala/tilelink/Broadcast.scala:401:14
  ...
  output [7:0]   io_cacheOH,	// src/main/scala/tilelink/Broadcast.scala:401:14
  input  [7:0]   io_clearOH	// src/main/scala/tilelink/Broadcast.scala:401:14
);
  ...
  wire [3:0]   io_probe_bits_count_0 = io_probe_bits_count;
  ...
  wire [7:0]   io_clearOH_0 = io_clearOH;
  wire         io_in_a_bits_user_amba_prot_bufferable = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_in_a_bits_user_amba_prot_modifiable = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_in_a_bits_user_amba_prot_readalloc = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_in_a_bits_user_amba_prot_writealloc = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_in_a_bits_user_amba_prot_privileged = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_in_a_bits_user_amba_prot_secure = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_in_a_bits_user_amba_prot_fetch = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_out_a_bits_user_amba_prot_bufferable = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_out_a_bits_user_amba_prot_modifiable = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_out_a_bits_user_amba_prot_readalloc = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_out_a_bits_user_amba_prot_writealloc = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_out_a_bits_user_amba_prot_privileged = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_out_a_bits_user_amba_prot_secure = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_out_a_bits_user_amba_prot_fetch = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire         io_out_a_bits_corrupt = 1'h0;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire [7:0]   io_probe_bits_cacheOH = 8'hFF;	// src/main/scala/tilelink/Broadcast.scala:401:14
  wire [15:0]  i_data_bits_mask = io_in_a_bits_mask_0;	// src/main/scala/tilelink/Broadcast.scala:483:20
  wire [127:0] i_data_bits_data = io_in_a_bits_data_0;	// src/main/scala/tilelink/Broadcast.scala:483:20
  ...
  reg  [5:0]   source;	// src/main/scala/tilelink/Broadcast.scala:430:20
  wire [5:0]   io_source_0 = source;	// src/main/scala/tilelink/Broadcast.scala:430:20
  ...
  reg  [3:0]   count;	// src/main/scala/tilelink/Broadcast.scala:434:20
  reg  [7:0]   cacheOH;	// src/main/scala/tilelink/Broadcast.scala:435:20
  wire [7:0]   io_cacheOH_0 = cacheOH;	// src/main/scala/tilelink/Broadcast.scala:435:20
  ...
  wire         probe_done = count == 4'h0;	// src/main/scala/tilelink/Broadcast.scala:434:20, :469:19, :491:26
  ...
  wire [1:0]   transform = {1'h1, ~shared};	// src/main/scala/tilelink/Broadcast.scala:424:24, :426:20, :494:22
  ...
  wire [7:0]   io_out_a_bits_source_0 = {acquire ? transform : 2'h0, source};	// src/main/scala/tilelink/Broadcast.scala:430:20, :492:52, :494:22, :501:{31,35}
  always @(posedge clock) begin
    if (reset) begin
      got_e <= 1'h1;	// src/main/scala/tilelink/Broadcast.scala:424:24
      sent_d <= 1'h1;	// src/main/scala/tilelink/Broadcast.scala:424:24, :425:24
    ...
    if (_GEN_0)	// src/main/scala/tilelink/Broadcast.scala:468:22
      count <= count - {2'h0, io_probenack_0 & io_probedack_0 ? 2'h2 : 2'h1};	// src/main/scala/tilelink/Broadcast.scala:434:20, :470:{20,25,39}
    else if (io_probe_valid_0)
      count <= io_probe_bits_count_0;	// src/main/scala/tilelink/Broadcast.scala:434:20
    else if (_GEN)	// src/main/scala/tilelink/Broadcast.scala:438:22
      count <= 4'h1;	// src/main/scala/tilelink/Broadcast.scala:434:20, :450:13
    if (io_probe_valid_0)
      cacheOH <= 8'hFF;	// src/main/scala/tilelink/Broadcast.scala:401:14, :435:20
    else
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        got_e = _RANDOM[2'h0][0];	// src/main/scala/tilelink/Broadcast.scala:424:24
        sent_d = _RANDOM[2'h0][1];	// src/main/scala/tilelink/Broadcast.scala:424:24, :425:24
        shared = _RANDOM[2'h0][2];	// src/main/scala/tilelink/Broadcast.scala:424:24, :426:20
        opcode = _RANDOM[2'h0][5:3];	// src/main/scala/tilelink/Broadcast.scala:424:24, :427:20
        param = _RANDOM[2'h0][8:6];	// src/main/scala/tilelink/Broadcast.scala:424:24, :428:20
        size = _RANDOM[2'h0][11:9];	// src/main/scala/tilelink/Broadcast.scala:424:24, :429:20
        source = _RANDOM[2'h0][17:12];	// src/main/scala/tilelink/Broadcast.scala:424:24, :430:20
        address = {_RANDOM[2'h0][31:25], _RANDOM[2'h1][24:0]};	// src/main/scala/tilelink/Broadcast.scala:424:24, :433:24
        count = _RANDOM[2'h1][28:25];	// src/main/scala/tilelink/Broadcast.scala:433:24, :434:20
        cacheOH = {_RANDOM[2'h1][31:29], _RANDOM[2'h2][4:0]};	// src/main/scala/tilelink/Broadcast.scala:433:24, :435:20
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_107 o_data_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
