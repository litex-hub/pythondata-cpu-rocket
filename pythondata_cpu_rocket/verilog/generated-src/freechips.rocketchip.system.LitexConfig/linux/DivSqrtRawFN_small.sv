...
module DivSqrtRawFN_small(
  ...
  wire [26:0] rem =
    ...
    | (inReady ? 27'h0 : {rem_Z, 1'h0});	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :242:29, :291:32, :299:42, :351:{12,21,24,47,57}, :352:{12,21}, :353:{16,27,56}, :354:27, :357:11, :358:{12,29}, :381:85, :385:81
  ...
  wire [25:0] _trialTerm_T_3 = inReady & ~io_sqrtOp_0 ? {io_b_sig_0, 1'h0} : 26'h0;	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :270:33, :299:42, :361:{12,21,48}, :381:85, :385:81
  wire [25:0] _trialTerm_T_9 =
    {_trialTerm_T_3[25], _trialTerm_T_3[24:0] | {inReady & evenSqrt_S, 24'h0}}
    | (_sigX_Z_T_7 ? 26'h2800000 : 26'h0);	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :290:32, :341:16, :352:21, :361:{12,74}, :362:{12,21,74}, :363:12, :385:81
  wire [26:0] trialTerm =
    {1'h0,
     _trialTerm_T_9[25],
     _trialTerm_T_9[24] | ~inReady & ~sqrtOp_Z,
     _trialTerm_T_9[23:0] | (inReady ? 24'h0 : fractB_Z)}
    | (~inReady & sqrtOp_Z ? {sigX_Z, 1'h0} : 27'h0);	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :227:29, :235:29, :244:29, :299:42, :339:23, :341:16, :352:12, :362:74, :363:74, :364:{12,74}, :365:{23,26,74}, :366:{12,23,44}, :381:85
  ...
  wire [26:0] rem2 = {nextRem_Z, 1'h0};	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:299:42, :370:54, :371:25, :381:85
  ...
  wire [26:0] trialTerm2_newBit1 =
    {trialTerm2_newBit0[26:25],
     trialTerm2_newBit0[24:0] | (sqrtOp_Z ? {fractB_Z, 1'h0} : 25'h0)};	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:227:29, :235:29, :299:42, :362:12, :372:33, :373:{49,54,73}, :381:85
  wire [27:0] _trialRem2_T_9 = {1'h0, rem_Z[24:0], 2'h0} - {1'h0, trialTerm2_newBit0};	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:242:29, :299:42, :372:33, :377:{23,44}, :381:85
  wire [29:0] trialRem2 =
    newBit
      ? {trialRem, 1'h0} - {3'h0, trialTerm2_newBit1}
      : {{2{_trialRem2_T_9[27]}}, _trialRem2_T_9};	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:299:42, :367:29, :368:23, :373:49, :375:12, :376:27, :377:44, :381:85
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      _cycleNum_T_15 =
        ...
        | (entering | skipCycle2 ? 5'h0 : cycleNum - 5'h1);	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:223:33, :276:27, :290:48, :296:28, :297:40, :300:63, :304:{26,28,57}, :305:16, :306:20, :307:24, :311:15, :312:{16,56}, :316:38
    ...
    if (entering | ~inReady & sqrtOp_Z) begin	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :227:29, :296:28, :339:{20,23,33}
      ...
      _fractB_Z_T_4 = inReady & ~io_sqrtOp_0 ? {io_b_sig_0[22:0], 1'h0} : 24'h0;	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :270:33, :299:42, :341:{16,25,73,90}, :381:85
    ...
    if (entering | ~inReady) begin	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :296:28, :339:23, :389:20
      ...
      _sigX_Z_T_3 = inReady & ~io_sqrtOp_0 ? {newBit, 25'h0} : 26'h0;	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :270:33, :362:12, :368:23, :385:81, :393:{16,25,50}
      _GEN = _sigX_Z_T_3[24:0] | {inReady & io_sqrtOp_0, 24'h0};	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :341:16, :393:{16,74}, :394:{16,25}
      ...
      sigX_Z <=
        ...
        | (inReady ? 26'h0 : sigX_Z) | (~inReady & newBit ? bitMask[25:0] : 26'h0);	// hardfloat/hardfloat/src/main/scala/DivSqrtRecFN_small.scala:224:33, :244:29, :339:23, :341:16, :342:16, :352:21, :359:34, :368:23, :385:81, :393:{16,74}, :394:74, :395:{16,50}, :396:{16,74}, :397:{16,27}
    end
  end // always @(posedge)
