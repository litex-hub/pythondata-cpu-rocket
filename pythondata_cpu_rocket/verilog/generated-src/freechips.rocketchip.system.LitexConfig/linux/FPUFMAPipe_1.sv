...
module FPUFMAPipe_1(
  ...
  wire [64:0] zero = (io_in_bits_in1_0 ^ io_in_bits_in2_0) & 65'h10000000000000000;	// src/main/scala/tile/FPU.scala:702:{32,50,57}
  wire [64:0] res_data_maskedNaN = _fma_io_out & 65'h1EFEFFFFFFFFFFFFF;	// src/main/scala/tile/FPU.scala:407:{25,27}, :710:19
  ...
  always @(posedge clock) begin
    ...
    if (reset)
      io_out_pipe_v <= 1'h0;	// src/main/scala/chisel3/util/Valid.scala:129:24, src/main/scala/tile/FPU.scala:698:22
    else
