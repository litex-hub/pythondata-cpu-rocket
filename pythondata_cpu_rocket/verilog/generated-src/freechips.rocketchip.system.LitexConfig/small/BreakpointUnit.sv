...
module BreakpointUnit(
  ...
  input         io_status_dv,	// src/main/scala/rocket/Breakpoint.scala:80:14
                io_status_v,	// src/main/scala/rocket/Breakpoint.scala:80:14
                io_status_mpv,	// src/main/scala/rocket/Breakpoint.scala:80:14
                io_status_gva,	// src/main/scala/rocket/Breakpoint.scala:80:14
  input  [1:0]  io_status_mpp,	// src/main/scala/rocket/Breakpoint.scala:80:14
  input         io_status_mpie,	// src/main/scala/rocket/Breakpoint.scala:80:14
  ...
  input  [32:0] io_pc,	// src/main/scala/rocket/Breakpoint.scala:80:14
  ...
  wire [32:0] io_bp_0_address_0 = io_bp_0_address;
  wire [47:0] io_bp_0_textra_pad2_0 = io_bp_0_textra_pad2;
  wire        io_bp_0_textra_pad1_0 = io_bp_0_textra_pad1;
  wire [32:0] io_pc_0 = io_pc;
  wire [32:0] io_ea_0 = io_ea;
  wire [1:0]  en_hi = 2'h2;	// src/main/scala/rocket/Breakpoint.scala:30:56
  wire        io_bp_0_control_m = 1'h1;	// src/main/scala/rocket/Breakpoint.scala:30:68, :55:126, :80:14, :109:15
  ...
  wire [1:0]  io_status_sxl = 2'h0;	// src/main/scala/rocket/Breakpoint.scala:30:56, :80:14
  wire [1:0]  io_status_uxl = 2'h0;	// src/main/scala/rocket/Breakpoint.scala:30:56, :80:14
  wire [1:0]  io_status_xs = 2'h0;	// src/main/scala/rocket/Breakpoint.scala:30:56, :80:14
  wire [1:0]  io_status_fs = 2'h0;	// src/main/scala/rocket/Breakpoint.scala:30:56, :80:14
  wire [1:0]  io_status_vs = 2'h0;	// src/main/scala/rocket/Breakpoint.scala:30:56, :80:14
  wire [1:0]  io_bp_0_control_zero = 2'h0;	// src/main/scala/rocket/Breakpoint.scala:30:56, :80:14
  wire [1:0]  en_lo = 2'h0;	// src/main/scala/rocket/Breakpoint.scala:30:56, :80:14
  ...
  wire        io_status_sd = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  ...
  wire        io_status_tsr = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  wire        io_status_tw = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  wire        io_status_tvm = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  wire        io_status_mxr = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  wire        io_status_sum = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  wire        io_status_mprv = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  wire        io_status_spp = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  wire        io_status_ube = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  wire        io_status_spie = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  ...
  wire        io_status_sie = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  ...
  wire        io_bp_0_control_s = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  wire        io_bp_0_control_u = 1'h0;	// src/main/scala/rocket/Breakpoint.scala:80:14
  ...
  wire [1:0]  io_status_dprv = 2'h3;	// src/main/scala/rocket/Breakpoint.scala:80:14
  wire [1:0]  io_status_prv = 2'h3;	// src/main/scala/rocket/Breakpoint.scala:80:14
  ...
  wire        en = ~io_status_debug_0;	// src/main/scala/rocket/Breakpoint.scala:30:{35,50}
  wire        _w_T_2 = io_ea_0 >= io_bp_0_address_0;	// src/main/scala/rocket/Breakpoint.scala:65:8
  wire [32:0] _w_T_5 = ~io_ea_0;	// src/main/scala/rocket/Breakpoint.scala:62:6
  ...
  wire [32:0] _x_T_15 = ~io_bp_0_address_0;	// src/main/scala/rocket/Breakpoint.scala:62:24
  ...
  assign r =
    ...
    & (io_bp_0_control_tmatch_0[1]
         ...
         : {_w_T_5[32:4],
            _w_T_5[3:0]
              | {r_hi, r_lo}} == {_x_T_15[32:4], _x_T_15[3:0] | {r_hi_1, r_lo_1}});	// src/main/scala/rocket/Breakpoint.scala:30:50, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :106:{32,58}, src/main/scala/util/package.scala:37:27
  ...
  assign w =
    ...
    & (io_bp_0_control_tmatch_0[1]
         ...
         : {_w_T_5[32:4],
            _w_T_5[3:0]
              | {w_hi, w_lo}} == {_x_T_15[32:4], _x_T_15[3:0] | {w_hi_1, w_lo_1}});	// src/main/scala/rocket/Breakpoint.scala:30:50, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :107:{32,58}, src/main/scala/util/package.scala:37:27
  wire        io_bpwatch_0_wvalid_0_0 = w;	// src/main/scala/rocket/Breakpoint.scala:107:58
  wire [32:0] _x_T_5 = ~io_pc_0;	// src/main/scala/rocket/Breakpoint.scala:62:6
  ...
  assign x =
    ...
    & (io_bp_0_control_tmatch_0[1]
         ...
         : {_x_T_5[32:4],
            _x_T_5[3:0]
              | {x_hi, x_lo}} == {_x_T_15[32:4], _x_T_15[3:0] | {x_hi_1, x_lo_1}});	// src/main/scala/rocket/Breakpoint.scala:30:50, :62:{6,9,19,24,33}, :65:{8,20,36}, :68:{8,23}, :108:{32,58}, src/main/scala/util/package.scala:37:27
  wire        io_bpwatch_0_ivalid_0_0 = x;	// src/main/scala/rocket/Breakpoint.scala:108:58
  wire [2:0]  io_bpwatch_0_action = {2'h0, io_bp_0_control_action_0};	// src/main/scala/rocket/Breakpoint.scala:30:56, :80:14, :112:16
