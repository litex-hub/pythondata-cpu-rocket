...
module IBuf(
  ...
  wire [32:0]  io_imem_bits_btb_target_0 = io_imem_bits_btb_target;
  ...
  wire [33:0]  io_imem_bits_pc_0 = io_imem_bits_pc;
  ...
  `endif // not def SYNTHESIS
  wire [33:0]  io_pc_0 = nBufValid ? buf_pc : io_imem_bits_pc_0;	// src/main/scala/rocket/IBuf.scala:34:47, :35:16, :82:15
  ...
  wire [32:0]  io_btb_resp_target_0 =
  ...
  always @(posedge clock) begin
    ...
    if (io_inst_0_ready_0 & _GEN_2) begin	// src/main/scala/rocket/IBuf.scala:35:16, :47:29, :54:{68,94}, :57:13
      ...
      buf_pc <=
        io_imem_bits_pc_0 & 34'h3FFFFFFFC | io_imem_bits_pc_0 + {31'h0, nICReady, 1'h0}
