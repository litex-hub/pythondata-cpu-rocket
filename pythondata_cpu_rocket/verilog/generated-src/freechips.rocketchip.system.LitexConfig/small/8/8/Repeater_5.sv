  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = {_RANDOM[2'h0][31:16], _RANDOM[2'h1][0]};	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_mask = _RANDOM[2'h1][8:1];	// src/main/scala/util/Repeater.scala:20:18
        saved_data = {_RANDOM[2'h1][31:9], _RANDOM[2'h2], _RANDOM[2'h3][8:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_corrupt = _RANDOM[2'h3][9];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
