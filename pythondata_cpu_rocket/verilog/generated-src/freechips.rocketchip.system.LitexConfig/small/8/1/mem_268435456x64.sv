...
module mem_268435456x64(	// src/main/scala/util/DescribedSRAM.scala:17:26
  input  [27:0] R0_addr,
  input         R0_en,
                R0_clk,
  output [63:0] R0_data,
  ...
  reg [63:0] Memory[0:268435455];	// src/main/scala/util/DescribedSRAM.scala:17:26
  reg        _R0_en_d0;	// src/main/scala/util/DescribedSRAM.scala:17:26
  reg [27:0] _R0_addr_d0;	// src/main/scala/util/DescribedSRAM.scala:17:26
    ...
    initial begin	// src/main/scala/util/DescribedSRAM.scala:17:26
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/util/DescribedSRAM.scala:17:26
        for (logic [28:0] i = 29'h0; i < 29'h10000000; i += 29'h1) begin
          ...
          Memory[i[27:0]] = _RANDOM_MEM;	// src/main/scala/util/DescribedSRAM.scala:17:26
        end	// src/main/scala/util/DescribedSRAM.scala:17:26
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/util/DescribedSRAM.scala:17:26
        ...
        _R0_addr_d0 = _RANDOM[28:1];	// src/main/scala/util/DescribedSRAM.scala:17:26
      `endif // RANDOMIZE_REG_INIT
    end // initial
