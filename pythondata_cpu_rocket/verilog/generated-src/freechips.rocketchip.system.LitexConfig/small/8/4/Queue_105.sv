...
module Queue_105(
  ...
  wire [255:0] io_deq_bits_data_0 = ram[255:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [31:0]  io_deq_bits_strb_0 = ram[287:256];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_last_0 = ram[288];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
