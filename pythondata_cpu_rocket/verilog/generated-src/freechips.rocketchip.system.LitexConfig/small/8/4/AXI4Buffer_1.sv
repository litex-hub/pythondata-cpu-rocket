...
module AXI4Buffer_1(
  ...
  wire [255:0] nodeIn_r_irr_bits_data;	// src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  Queue_154 nodeOut_aw_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_155 nodeOut_w_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
  ...
  Queue_156 nodeIn_b_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_154 nodeOut_ar_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_158 nodeIn_r_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock                      (clock),
    .reset                      (reset),
