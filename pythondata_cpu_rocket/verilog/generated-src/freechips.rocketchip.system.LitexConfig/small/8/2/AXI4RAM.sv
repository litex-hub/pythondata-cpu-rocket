...
module AXI4RAM(
  ...
  wire [127:0] _mem_ext_R0_data;	// src/main/scala/util/DescribedSRAM.scala:17:26
  ...
  wire [1:0]   r_addr_lo_lo_lo_hi = nodeIn_ar_bits_addr[6:5];	// src/main/scala/amba/axi4/SRAM.scala:65:21, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [2:0]   r_addr_lo_lo_lo = {r_addr_lo_lo_lo_hi, nodeIn_ar_bits_addr[4]};	// src/main/scala/amba/axi4/SRAM.scala:65:{21,49,73}, src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [2:0]   r_addr_lo_lo_hi = {r_addr_lo_lo_hi_hi, nodeIn_ar_bits_addr[7]};	// src/main/scala/amba/axi4/SRAM.scala:65:{21,49,73}, src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [26:0]  r_addr = {r_addr_hi, r_addr_lo};	// src/main/scala/amba/axi4/SRAM.scala:65:21
  wire [1:0]   w_addr_lo_lo_lo_hi = nodeIn_aw_bits_addr[6:5];	// src/main/scala/amba/axi4/SRAM.scala:66:21, src/main/scala/diplomacy/Nodes.scala:1214:17
  wire [2:0]   w_addr_lo_lo_lo = {w_addr_lo_lo_lo_hi, nodeIn_aw_bits_addr[4]};	// src/main/scala/amba/axi4/SRAM.scala:66:{21,49,73}, src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [2:0]   w_addr_lo_lo_hi = {w_addr_lo_lo_hi_hi, nodeIn_aw_bits_addr[7]};	// src/main/scala/amba/axi4/SRAM.scala:66:{21,49,73}, src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [26:0]  w_addr = {w_addr_hi, w_addr_lo};	// src/main/scala/amba/axi4/SRAM.scala:66:21
  ...
  wire [15:0]  nodeIn_r_bits_data_lo_lo_lo = {rdata_1, rdata_0};	// src/main/scala/amba/axi4/SRAM.scala:121:26, src/main/scala/util/package.scala:80:42
  wire [15:0]  nodeIn_r_bits_data_lo_lo_hi = {rdata_3, rdata_2};	// src/main/scala/amba/axi4/SRAM.scala:121:26, src/main/scala/util/package.scala:80:42
  wire [31:0]  nodeIn_r_bits_data_lo_lo =
    {nodeIn_r_bits_data_lo_lo_hi, nodeIn_r_bits_data_lo_lo_lo};	// src/main/scala/amba/axi4/SRAM.scala:121:26
  wire [15:0]  nodeIn_r_bits_data_lo_hi_lo = {rdata_5, rdata_4};	// src/main/scala/amba/axi4/SRAM.scala:121:26, src/main/scala/util/package.scala:80:42
  wire [15:0]  nodeIn_r_bits_data_lo_hi_hi = {rdata_7, rdata_6};	// src/main/scala/amba/axi4/SRAM.scala:121:26, src/main/scala/util/package.scala:80:42
  wire [31:0]  nodeIn_r_bits_data_lo_hi =
    {nodeIn_r_bits_data_lo_hi_hi, nodeIn_r_bits_data_lo_hi_lo};	// src/main/scala/amba/axi4/SRAM.scala:121:26
  wire [63:0]  nodeIn_r_bits_data_lo =
    {nodeIn_r_bits_data_lo_hi, nodeIn_r_bits_data_lo_lo};	// src/main/scala/amba/axi4/SRAM.scala:121:26
  wire [15:0]  nodeIn_r_bits_data_hi_lo_lo = {rdata_9, rdata_8};	// src/main/scala/amba/axi4/SRAM.scala:121:26, src/main/scala/util/package.scala:80:42
  wire [15:0]  nodeIn_r_bits_data_hi_lo_hi = {rdata_11, rdata_10};	// src/main/scala/amba/axi4/SRAM.scala:121:26, src/main/scala/util/package.scala:80:42
  wire [31:0]  nodeIn_r_bits_data_hi_lo =
    {nodeIn_r_bits_data_hi_lo_hi, nodeIn_r_bits_data_hi_lo_lo};	// src/main/scala/amba/axi4/SRAM.scala:121:26
  wire [15:0]  nodeIn_r_bits_data_hi_hi_lo = {rdata_13, rdata_12};	// src/main/scala/amba/axi4/SRAM.scala:121:26, src/main/scala/util/package.scala:80:42
  wire [15:0]  nodeIn_r_bits_data_hi_hi_hi = {rdata_15, rdata_14};	// src/main/scala/amba/axi4/SRAM.scala:121:26, src/main/scala/util/package.scala:80:42
  wire [31:0]  nodeIn_r_bits_data_hi_hi =
    {nodeIn_r_bits_data_hi_hi_hi, nodeIn_r_bits_data_hi_hi_lo};	// src/main/scala/amba/axi4/SRAM.scala:121:26
  wire [63:0]  nodeIn_r_bits_data_hi =
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        w_full = _RANDOM[3'h0][0];	// src/main/scala/amba/axi4/SRAM.scala:70:25
        w_id = _RANDOM[3'h0][4:1];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :71:21
        w_echo_real_last = _RANDOM[3'h0][5];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :72:21
        r_sel1 = _RANDOM[3'h0][6];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :73:25
        w_sel1 = _RANDOM[3'h0][7];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :74:25
        r_full = _RANDOM[3'h0][8];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :99:25
        r_id = _RANDOM[3'h0][12:9];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :100:21
        r_echo_real_last = _RANDOM[3'h0][13];	// src/main/scala/amba/axi4/SRAM.scala:70:25, :101:21
        rdata_REG = _RANDOM[3'h0][14];	// src/main/scala/amba/axi4/SRAM.scala:70:25, src/main/scala/util/package.scala:92:91
        rdata_r_0 = _RANDOM[3'h0][22:15];	// src/main/scala/amba/axi4/SRAM.scala:70:25, src/main/scala/util/package.scala:80:63
        rdata_r_1 = _RANDOM[3'h0][30:23];	// src/main/scala/amba/axi4/SRAM.scala:70:25, src/main/scala/util/package.scala:80:63
        rdata_r_2 = {_RANDOM[3'h0][31], _RANDOM[3'h1][6:0]};	// src/main/scala/amba/axi4/SRAM.scala:70:25, src/main/scala/util/package.scala:80:63
        rdata_r_3 = _RANDOM[3'h1][14:7];	// src/main/scala/util/package.scala:80:63
        rdata_r_4 = _RANDOM[3'h1][22:15];	// src/main/scala/util/package.scala:80:63
        rdata_r_5 = _RANDOM[3'h1][30:23];	// src/main/scala/util/package.scala:80:63
        rdata_r_6 = {_RANDOM[3'h1][31], _RANDOM[3'h2][6:0]};	// src/main/scala/util/package.scala:80:63
        rdata_r_7 = _RANDOM[3'h2][14:7];	// src/main/scala/util/package.scala:80:63
        rdata_r_8 = _RANDOM[3'h2][22:15];	// src/main/scala/util/package.scala:80:63
        rdata_r_9 = _RANDOM[3'h2][30:23];	// src/main/scala/util/package.scala:80:63
        rdata_r_10 = {_RANDOM[3'h2][31], _RANDOM[3'h3][6:0]};	// src/main/scala/util/package.scala:80:63
        rdata_r_11 = _RANDOM[3'h3][14:7];	// src/main/scala/util/package.scala:80:63
        rdata_r_12 = _RANDOM[3'h3][22:15];	// src/main/scala/util/package.scala:80:63
        rdata_r_13 = _RANDOM[3'h3][30:23];	// src/main/scala/util/package.scala:80:63
        rdata_r_14 = {_RANDOM[3'h3][31], _RANDOM[3'h4][6:0]};	// src/main/scala/util/package.scala:80:63
        rdata_r_15 = _RANDOM[3'h4][14:7];	// src/main/scala/util/package.scala:80:63
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  mem_134217728x128 mem_ext (	// src/main/scala/util/DescribedSRAM.scala:17:26
