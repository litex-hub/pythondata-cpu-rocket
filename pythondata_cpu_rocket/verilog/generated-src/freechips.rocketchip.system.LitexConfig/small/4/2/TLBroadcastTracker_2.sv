...
module TLBroadcastTracker_2(
  ...
  input  [2:0]   io_probe_bits_count,	// src/main/scala/tilelink/Broadcast.scala:401:14
  ...
  output [3:0]   io_cacheOH,	// src/main/scala/tilelink/Broadcast.scala:401:14
  input  [3:0]   io_clearOH	// src/main/scala/tilelink/Broadcast.scala:401:14
);
  ...
  wire [2:0]   io_probe_bits_count_0 = io_probe_bits_count;
  ...
  wire [3:0]   io_clearOH_0 = io_clearOH;
  ...
  wire [3:0]   io_probe_bits_cacheOH = 4'hF;	// src/main/scala/tilelink/Broadcast.scala:401:14
  ...
  reg  [2:0]   count;	// src/main/scala/tilelink/Broadcast.scala:434:20
  reg  [3:0]   cacheOH;	// src/main/scala/tilelink/Broadcast.scala:435:20
  wire [3:0]   io_cacheOH_0 = cacheOH;	// src/main/scala/tilelink/Broadcast.scala:435:20
  ...
  wire         probe_done = count == 3'h0;	// src/main/scala/tilelink/Broadcast.scala:434:20, :469:19, :491:26, :499:31
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_0)	// src/main/scala/tilelink/Broadcast.scala:468:22
      count <= count - {1'h0, io_probenack_0 & io_probedack_0 ? 2'h2 : 2'h1};	// src/main/scala/tilelink/Broadcast.scala:434:20, :470:{20,25,39}
      ...
      count <= 3'h1;	// src/main/scala/tilelink/Broadcast.scala:434:20, :450:13
    if (io_probe_valid_0)
      cacheOH <= 4'hF;	// src/main/scala/tilelink/Broadcast.scala:401:14, :435:20
    else
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        count = _RANDOM[1'h1][26:24];	// src/main/scala/tilelink/Broadcast.scala:433:24, :434:20
        cacheOH = _RANDOM[1'h1][30:27];	// src/main/scala/tilelink/Broadcast.scala:433:24, :435:20
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_101 o_data_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
