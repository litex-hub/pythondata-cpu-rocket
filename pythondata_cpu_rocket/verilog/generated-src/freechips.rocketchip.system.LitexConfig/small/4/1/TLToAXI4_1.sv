...
module TLToAXI4_1(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_denied_r = _RANDOM[4'h0][9];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/util/package.scala:80:63
  ...
  Queue_47 nodeOut_w_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
