...
module ram_4x144(	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  input  [1:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [143:0] Memory[0:3];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:274:95
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          ...
          Memory[i[1:0]] = _RANDOM_MEM[143:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        end	// src/main/scala/chisel3/util/Decoupled.scala:274:95
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 144'bx;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
