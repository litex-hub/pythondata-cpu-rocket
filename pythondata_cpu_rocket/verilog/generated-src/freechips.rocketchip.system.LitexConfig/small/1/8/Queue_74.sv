...
module Queue_74(
  ...
  wire [63:0]  io_enq_bits_mask_0 = io_enq_bits_mask;
  ...
  reg  [575:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0]  io_deq_bits_mask_0 = ram[63:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [511:0] io_deq_bits_data_0 = ram[575:64];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  always @(posedge clock) begin
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <= {io_enq_bits_data_0, io_enq_bits_mask_0};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    if (reset)
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram =
          {_RANDOM[5'h0][31:1],
           ...
           _RANDOM[5'h10],
           _RANDOM[5'h11],
           _RANDOM[5'h12][0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
