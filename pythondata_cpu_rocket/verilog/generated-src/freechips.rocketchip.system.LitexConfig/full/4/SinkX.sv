...
module SinkX(
  ...
  wire [4:0]  io_req_bits_source = 5'h0;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkX.scala:49:22
  wire [5:0]  io_req_bits_offset = 6'h0;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkX.scala:50:22
  wire [5:0]  io_req_bits_put = 6'h0;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkX.scala:50:22
  ...
  Queue_100 x_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock               (clock),
    .reset               (reset),
