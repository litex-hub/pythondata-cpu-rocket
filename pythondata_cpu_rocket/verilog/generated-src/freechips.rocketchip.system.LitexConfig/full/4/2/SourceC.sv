...
module SourceC(
  ...
  output [127:0] io_c_bits_data,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14
  ...
  output [1:0]   io_bs_adr_bits_beat,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14
  input  [127:0] io_bs_dat_data,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:37:14
  ...
  wire [127:0] io_bs_dat_data_0 = io_bs_dat_data;
  ...
  wire [1:0]   io_bs_adr_bits_mask = 2'h3;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:68:23
  ...
  wire [127:0] c_bits_data = io_bs_dat_data_0;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:108:15
  ...
  reg  [1:0]   beat;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:67:21
  wire [1:0]   io_bs_adr_bits_beat_0 = beat;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:67:21
  ...
  reg  [1:0]   s2_beat;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:99:26
  ...
  reg  [1:0]   s3_beat;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:105:26
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      beat <= 2'h0;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:67:21
    end
    else begin
      ...
      if (_s2_latch_T) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
        if (last)	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:68:19
          ...
          beat <= beat + 2'h1;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:61:23, :67:21, :89:18
      end
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        fill = _RANDOM[3'h0][2:0];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21
        room = _RANDOM[3'h0][3];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :59:21
        busy = _RANDOM[3'h0][4];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :66:21
        beat = _RANDOM[3'h0][6:5];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :67:21
        req_r_opcode = _RANDOM[3'h0][9:7];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47
        req_r_param = _RANDOM[3'h0][12:10];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47
        req_r_source = _RANDOM[3'h0][15:13];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47
        req_r_tag = _RANDOM[3'h0][30:16];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47
        req_r_set = {_RANDOM[3'h0][31], _RANDOM[3'h1][8:0]};	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:58:21, :69:47
        req_r_way = _RANDOM[3'h1][11:9];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47
        req_r_dirty = _RANDOM[3'h1][12];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47
        s2_valid = _RANDOM[3'h1][13];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :97:25
        s2_req_opcode = _RANDOM[3'h1][16:14];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25
        s2_req_param = _RANDOM[3'h1][19:17];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25
        s2_req_source = _RANDOM[3'h1][22:20];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25
        s2_req_tag = {_RANDOM[3'h1][31:23], _RANDOM[3'h2][5:0]};	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:69:47, :98:25
        s2_req_set = _RANDOM[3'h2][15:6];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25
        s2_req_way = _RANDOM[3'h2][18:16];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25
        s2_req_dirty = _RANDOM[3'h2][19];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25
        s2_beat = _RANDOM[3'h2][21:20];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :99:26
        s2_last = _RANDOM[3'h2][22];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :100:26
        s3_valid = _RANDOM[3'h2][23];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :103:25
        s3_req_opcode = _RANDOM[3'h2][26:24];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :104:25
        s3_req_param = _RANDOM[3'h2][29:27];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :104:25
        s3_req_source = {_RANDOM[3'h2][31:30], _RANDOM[3'h3][0]};	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:98:25, :104:25
        s3_req_tag = _RANDOM[3'h3][15:1];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25
        s3_req_set = _RANDOM[3'h3][25:16];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25
        s3_req_way = _RANDOM[3'h3][28:26];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25
        s3_req_dirty = _RANDOM[3'h3][29];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25
        s3_beat = _RANDOM[3'h3][31:30];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:104:25, :105:26
        s3_last = _RANDOM[3'h4][0];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceC.scala:106:26
      `endif // RANDOMIZE_REG_INIT
    end // initial
