...
module ram_6x301(	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  input  [2:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [300:0] Memory[0:5];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    initial begin	// src/main/scala/chisel3/util/Decoupled.scala:274:95
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        for (logic [2:0] i = 3'h0; i < 3'h6; i += 3'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[300:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        end	// src/main/scala/chisel3/util/Decoupled.scala:274:95
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 301'bx;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
endmodule
