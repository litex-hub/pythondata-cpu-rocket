...
module Queue_71(
  ...
  wire        io_deq_bits_noop_0 = ram[0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]  io_deq_bits_way_0 = ram[3:1];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [9:0]  io_deq_bits_set_0 = ram[13:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]  io_deq_bits_beat_0 = ram[16:14];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_mask_0 = ram[17];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <=
        {1'h1,
         ...
         io_enq_bits_set_0,
         io_enq_bits_way_0,
         io_enq_bits_noop_0};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    if (reset)
  ...
  assign io_deq_bits_noop = io_deq_bits_noop_0;
  assign io_deq_bits_way = io_deq_bits_way_0;
  assign io_deq_bits_set = io_deq_bits_set_0;
  assign io_deq_bits_beat = io_deq_bits_beat_0;
