...
module Queue_41(
  ...
  wire [8:0]  io_enq_bits_source_0 = io_enq_bits_source;
  ...
  wire        io_enq_bits_sink = 1'h0;	// src/main/scala/chisel3/util/Counter.scala:61:73, src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :327:32
  wire        io_enq_bits_denied = 1'h0;	// src/main/scala/chisel3/util/Counter.scala:61:73, src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :327:32
  wire        io_enq_bits_corrupt = 1'h0;	// src/main/scala/chisel3/util/Counter.scala:61:73, src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :327:32
  ...
  wire [1:0]  io_deq_bits_param_0 = ram[4:3];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [1:0]  io_deq_bits_size_0 = ram[6:5];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [8:0]  io_deq_bits_source_0 = ram[15:7];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_sink_0 = ram[16];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_denied_0 = ram[17];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0] io_deq_bits_data_0 = ram[81:18];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_corrupt_0 = ram[82];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
    ...
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:281:27
      ram <=
        {1'h0,
         ...
         io_enq_bits_size_0,
         2'h0,
         io_enq_bits_opcode_0};	// src/main/scala/chisel3/util/Counter.scala:61:73, src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :327:32
    if (reset)
