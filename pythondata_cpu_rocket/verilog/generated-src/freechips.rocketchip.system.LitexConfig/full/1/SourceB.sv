...
module SourceB(
  ...
  input         io_req_bits_clients,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:35:14
                io_b_ready,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:35:14
  ...
  wire        io_req_bits_clients_0 = io_req_bits_clients;
  ...
  wire [4:0]  io_b_bits_source = 5'h10;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:35:14, :65:17
  wire [4:0]  b_bits_source = 5'h10;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:35:14, :65:17
  ...
  reg         remain;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25
  wire        busy = remain;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :51:23
  wire        todo = busy ? remain : io_req_bits_clients_0;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :51:23, :52:19
  wire [1:0]  next = {1'h0, todo};	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:52:19, :53:37
  `ifndef SYNTHESIS	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:59:12
    always @(posedge clock) begin	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:59:12
      if (~reset & ~(~io_req_valid_0 | io_req_bits_clients_0)) begin	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:59:{12,13,27}
  ...
  wire        remain_set = _param_T_1 & io_req_bits_clients_0;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:47:30, :62:{24,37}
  ...
  wire        remain_clr = b_ready & b_valid & next[0];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:48:30, :53:37, :65:17, :69:{19,32}
  ...
  always @(posedge clock) begin
    if (reset)
      remain <= 1'h0;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25
    else
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        remain = _RANDOM[/*Zero width*/ 1'b0][0];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25
        tag_r = _RANDOM[/*Zero width*/ 1'b0][15:1];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :72:52
        set_r = _RANDOM[/*Zero width*/ 1'b0][25:16];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :73:52
        param_r = _RANDOM[/*Zero width*/ 1'b0][28:26];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :74:56
      `endif // RANDOMIZE_REG_INIT
    end // initial
