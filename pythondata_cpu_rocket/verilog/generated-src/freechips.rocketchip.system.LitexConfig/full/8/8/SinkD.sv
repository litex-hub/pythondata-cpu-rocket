...
module SinkD(
  ...
  input  [511:0] io_d_bits_data,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14
  ...
  output         io_bs_adr_bits_beat,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14
  output [511:0] io_bs_dat_data,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14
  ...
  wire [511:0] io_d_bits_data_0 = io_d_bits_data;
  ...
  wire         io_resp_bits_last = 1'h1;
  wire         last = 1'h1;	// src/main/scala/tilelink/Edges.scala:233:33
  ...
  wire         beat = 1'h0;	// src/main/scala/tilelink/Edges.scala:235:25
  wire [7:0]   io_bs_adr_bits_mask = 8'hFF;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:79:26
  ...
  assign io_resp_valid_0 = _io_resp_valid_T_1;	// src/main/scala/chisel3/util/Decoupled.scala:52:35
  wire         done;	// src/main/scala/tilelink/Edges.scala:234:22
  assign done = _io_resp_valid_T_1;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/tilelink/Edges.scala:234:22
  ...
  wire         first = ~counter;	// src/main/scala/tilelink/Edges.scala:230:27, :232:25
  ...
  reg          io_bs_adr_bits_beat_r;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:54
  wire         io_bs_adr_bits_beat_0 = ~_d_q_io_deq_valid & io_bs_adr_bits_beat_r;	// src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:{29,54}
  ...
  always @(posedge clock) begin
    ...
    else if (_io_resp_valid_T_1)	// src/main/scala/chisel3/util/Decoupled.scala:52:35
      counter <= ~first & counter1;	// src/main/scala/tilelink/Edges.scala:230:27, :231:28, :232:25, :237:21
    if (_d_q_io_deq_valid) begin	// src/main/scala/chisel3/util/Decoupled.scala:376:21
      ...
      io_bs_adr_bits_beat_r <= io_bs_adr_ready_0;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:54
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_source_r = _RANDOM[/*Zero width*/ 1'b0][3:1];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:57:53, src/main/scala/tilelink/Edges.scala:230:27
        io_bs_adr_bits_beat_r = _RANDOM[/*Zero width*/ 1'b0][4];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:54, src/main/scala/tilelink/Edges.scala:230:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
