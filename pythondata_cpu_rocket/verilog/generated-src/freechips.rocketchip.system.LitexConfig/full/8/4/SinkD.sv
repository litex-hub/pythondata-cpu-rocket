...
module SinkD(
  ...
  input  [255:0] io_d_bits_data,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14
  ...
  output [255:0] io_bs_dat_data,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14
  ...
  wire [255:0] io_d_bits_data_0 = io_d_bits_data;
  ...
  wire [3:0]   io_bs_adr_bits_mask = 4'hF;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:79:26
  ...
  assign last = counter | ~beats1;	// src/main/scala/tilelink/Edges.scala:222:14, :230:27, :233:{33,43}
  ...
  wire         beat = beats1 & ~counter1;	// src/main/scala/tilelink/Edges.scala:222:14, :231:28, :235:{25,27}
  ...
  wire         io_bs_adr_bits_beat_0 = _d_q_io_deq_valid ? beat : io_bs_adr_bits_beat_r;	// src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:{29,54}, src/main/scala/tilelink/Edges.scala:235:25
  ...
  always @(posedge clock) begin
    ...
    if (_d_q_io_deq_valid) begin	// src/main/scala/chisel3/util/Decoupled.scala:376:21
      ...
      io_bs_adr_bits_beat_r <= beat + io_bs_adr_ready_0;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:{54,60}, src/main/scala/tilelink/Edges.scala:235:25
    end
  end // always @(posedge)
