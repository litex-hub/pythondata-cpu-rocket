...
module Queue_74(
  ...
  wire [9:0]  io_enq_bits_source_0 = io_enq_bits_source;
  ...
  reg  [83:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [9:0]  io_deq_bits_source_0 = ram[16:7];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_sink_0 = ram[17];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_denied_0 = ram[18];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0] io_deq_bits_data_0 = ram[82:19];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_corrupt_0 = ram[83];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][20:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
