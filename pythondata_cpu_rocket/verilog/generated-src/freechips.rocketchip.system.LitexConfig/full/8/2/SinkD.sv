...
module SinkD(
  ...
  input  [127:0] io_d_bits_data,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14
  ...
  output [1:0]   io_bs_adr_bits_beat,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14
  output [127:0] io_bs_dat_data,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:36:14
  ...
  wire [127:0] io_d_bits_data_0 = io_d_bits_data;
  ...
  wire [1:0]   io_bs_adr_bits_mask = 2'h3;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:79:26
  ...
  wire [1:0]   beats1 = beats1_opdata ? beats1_decode : 2'h0;	// src/main/scala/tilelink/Edges.scala:107:36, :221:59, :222:14, :230:27
  ...
  wire         first = counter == 2'h0;	// src/main/scala/tilelink/Edges.scala:230:27, :232:25
  assign last = counter == 2'h1 | beats1 == 2'h0;	// src/main/scala/tilelink/Edges.scala:222:14, :230:27, :233:{25,33,43}
  ...
  wire [1:0]   beat = beats1 & ~counter1;	// src/main/scala/tilelink/Edges.scala:222:14, :231:28, :235:{25,27}
  ...
  reg  [1:0]   io_bs_adr_bits_beat_r;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:54
  wire [1:0]   io_bs_adr_bits_beat_0 = _d_q_io_deq_valid ? beat : io_bs_adr_bits_beat_r;	// src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:{29,54}, src/main/scala/tilelink/Edges.scala:235:25
  ...
  always @(posedge clock) begin
    ...
    if (_d_q_io_deq_valid) begin	// src/main/scala/chisel3/util/Decoupled.scala:376:21
      ...
      io_bs_adr_bits_beat_r <= beat + {1'h0, io_bs_adr_ready_0};	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:{54,60}, src/main/scala/tilelink/Edges.scala:235:25
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_source_r = _RANDOM[/*Zero width*/ 1'b0][4:2];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:57:53, src/main/scala/tilelink/Edges.scala:230:27
        io_bs_adr_bits_beat_r = _RANDOM[/*Zero width*/ 1'b0][6:5];	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkD.scala:78:54, src/main/scala/tilelink/Edges.scala:230:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
