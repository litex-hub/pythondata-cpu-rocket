...
module mem_134217728x128(	// src/main/scala/util/DescribedSRAM.scala:17:26
  input  [26:0]  R0_addr,
  input          R0_en,
                 R0_clk,
  ...
  reg [127:0] Memory[0:134217727];	// src/main/scala/util/DescribedSRAM.scala:17:26
  reg         _R0_en_d0;	// src/main/scala/util/DescribedSRAM.scala:17:26
  reg [26:0]  _R0_addr_d0;	// src/main/scala/util/DescribedSRAM.scala:17:26
  ...
  `ifdef ENABLE_INITIAL_MEM_	// src/main/scala/util/DescribedSRAM.scala:17:26
    ...
    initial begin	// src/main/scala/util/DescribedSRAM.scala:17:26
      ...
      `ifdef RANDOMIZE_MEM_INIT	// src/main/scala/util/DescribedSRAM.scala:17:26
        for (logic [27:0] i = 28'h0; i < 28'h8000000; i += 28'h1) begin
          ...
          Memory[i[26:0]] = _RANDOM_MEM;	// src/main/scala/util/DescribedSRAM.scala:17:26
        end	// src/main/scala/util/DescribedSRAM.scala:17:26
      `endif // RANDOMIZE_MEM_INIT
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/util/DescribedSRAM.scala:17:26
        ...
        _R0_addr_d0 = _RANDOM[27:1];	// src/main/scala/util/DescribedSRAM.scala:17:26
      `endif // RANDOMIZE_REG_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = _R0_en_d0 ? Memory[_R0_addr_d0] : 128'bx;	// src/main/scala/util/DescribedSRAM.scala:17:26
endmodule
