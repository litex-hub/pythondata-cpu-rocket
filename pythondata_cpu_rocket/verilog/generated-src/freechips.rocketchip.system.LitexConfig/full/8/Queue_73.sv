...
module Queue_73(
  ...
  reg  [116:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [9:0]   io_deq_bits_source_0 = ram[17:8];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [25:0]  io_deq_bits_address_0 = ram[43:18];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]   io_deq_bits_mask_0 = ram[51:44];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0]  io_deq_bits_data_0 = ram[115:52];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_corrupt_0 = ram[116];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][21:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
