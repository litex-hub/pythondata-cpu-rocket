...
module IBuf(
  ...
  input  [40:0] io_imem_bits_btb_target,	// src/main/scala/rocket/IBuf.scala:22:14
  ...
  input  [42:0] io_imem_bits_pc,	// src/main/scala/rocket/IBuf.scala:22:14
  ...
  output [42:0] io_pc,	// src/main/scala/rocket/IBuf.scala:22:14
  ...
  output [40:0] io_btb_resp_target,	// src/main/scala/rocket/IBuf.scala:22:14
  ...
  wire [40:0]  io_imem_bits_btb_target_0 = io_imem_bits_btb_target;
  ...
  wire [42:0]  io_imem_bits_pc_0 = io_imem_bits_pc;
  ...
  reg  [40:0]  buf_btb_target;	// src/main/scala/rocket/IBuf.scala:35:16
  ...
  reg  [42:0]  buf_pc;	// src/main/scala/rocket/IBuf.scala:35:16
  ...
  reg  [40:0]  ibufBTBResp_target;	// src/main/scala/rocket/IBuf.scala:36:24
  ...
  wire [1:0]   _GEN = {1'h0, pcWordBits};	// src/main/scala/rocket/IBuf.scala:34:47, :41:86, src/main/scala/util/package.scala:155:13
  wire [1:0]   nIC =
    ...
    always @(posedge clock) begin	// src/main/scala/rocket/IBuf.scala:79:9
      if (~reset
          & ~(~io_imem_valid_0 | ~io_imem_bits_btb_taken_0
              | io_imem_bits_btb_bridx_0 >= pcWordBits)) begin	// src/main/scala/rocket/IBuf.scala:79:{9,10,28,52,78}, src/main/scala/util/package.scala:155:13
  ...
  `endif // not def SYNTHESIS
  wire [42:0]  io_pc_0 = nBufValid ? buf_pc : io_imem_bits_pc_0;	// src/main/scala/rocket/IBuf.scala:34:47, :35:16, :82:15
  ...
  wire [40:0]  io_btb_resp_target_0 =
  ...
  always @(posedge clock) begin
    ...
    if (reset)
      ...
      nBufValid <=
        ...
        & (io_inst_0_ready_0
             ...
             : nBufValid);	// src/main/scala/rocket/IBuf.scala:34:47, :40:27, :44:{47,94}, :47:29, :48:{17,23,61}, :54:{68,94}, :56:{19,26}, :63:20, :64:17, src/main/scala/util/package.scala:210:{38,43}
    if (io_inst_0_ready_0 & _GEN_2) begin	// src/main/scala/rocket/IBuf.scala:35:16, :47:29, :54:{68,94}, :57:13
      ...
      buf_pc <=
        io_imem_bits_pc_0 & 43'h7FFFFFFFFFC | io_imem_bits_pc_0 + {40'h0, nICReady, 1'h0}
        & 43'h3;	// src/main/scala/rocket/IBuf.scala:34:47, :35:16, :42:25, :59:{35,37,49,68,109}
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        buf_btb_target = {_RANDOM[3'h0][31:7], _RANDOM[3'h1][15:0]};	// src/main/scala/rocket/IBuf.scala:34:47, :35:16
        buf_btb_entry = _RANDOM[3'h1][20:16];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_btb_bht_history = _RANDOM[3'h1][28:21];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_btb_bht_value = _RANDOM[3'h1][29];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_pc = {_RANDOM[3'h1][31:30], _RANDOM[3'h2], _RANDOM[3'h3][8:0]};	// src/main/scala/rocket/IBuf.scala:35:16
        buf_data = {_RANDOM[3'h3][31:9], _RANDOM[3'h4][8:0]};	// src/main/scala/rocket/IBuf.scala:35:16
        buf_mask = _RANDOM[3'h4][10:9];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_xcpt_pf_inst = _RANDOM[3'h4][11];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_xcpt_gf_inst = _RANDOM[3'h4][12];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_xcpt_ae_inst = _RANDOM[3'h4][13];	// src/main/scala/rocket/IBuf.scala:35:16
        buf_replay = _RANDOM[3'h4][14];	// src/main/scala/rocket/IBuf.scala:35:16
        ibufBTBResp_cfiType = _RANDOM[3'h4][16:15];	// src/main/scala/rocket/IBuf.scala:35:16, :36:24
        ibufBTBResp_taken = _RANDOM[3'h4][17];	// src/main/scala/rocket/IBuf.scala:35:16, :36:24
        ibufBTBResp_mask = _RANDOM[3'h4][19:18];	// src/main/scala/rocket/IBuf.scala:35:16, :36:24
        ibufBTBResp_bridx = _RANDOM[3'h4][20];	// src/main/scala/rocket/IBuf.scala:35:16, :36:24
        ibufBTBResp_target = {_RANDOM[3'h4][31:21], _RANDOM[3'h5][29:0]};	// src/main/scala/rocket/IBuf.scala:35:16, :36:24
        ibufBTBResp_entry = {_RANDOM[3'h5][31:30], _RANDOM[3'h6][2:0]};	// src/main/scala/rocket/IBuf.scala:36:24
        ibufBTBResp_bht_history = _RANDOM[3'h6][10:3];	// src/main/scala/rocket/IBuf.scala:36:24
        ibufBTBResp_bht_value = _RANDOM[3'h6][11];	// src/main/scala/rocket/IBuf.scala:36:24
      `endif // RANDOMIZE_REG_INIT
    end // initial
