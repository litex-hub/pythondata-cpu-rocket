    ...
    always @(posedge clock) begin	// src/main/scala/tilelink/Monitor.scala:42:11
      ...
      if (_GEN_6
          & ~({io_in_a_bits_address_0[31:14], ~(io_in_a_bits_address_0[13:12])} == 20'h0
              ...
              | {io_in_a_bits_address_0[31:26],
                 io_in_a_bits_address_0[25:12] ^ 14'h2010} == 20'h0
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        sink = _RANDOM[3'h2][9:7];	// src/main/scala/tilelink/Monitor.scala:536:22, :539:22
        denied = _RANDOM[3'h2][10];	// src/main/scala/tilelink/Monitor.scala:536:22, :540:22
        inflight = _RANDOM[3'h2][11];	// src/main/scala/tilelink/Monitor.scala:536:22, :611:27
        inflight_opcodes = _RANDOM[3'h2][15:12];	// src/main/scala/tilelink/Monitor.scala:536:22, :613:35
        inflight_sizes = _RANDOM[3'h2][23:16];	// src/main/scala/tilelink/Monitor.scala:536:22, :615:33
        a_first_counter_1 = {_RANDOM[3'h2][31:24], _RANDOM[3'h3][0]};	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/Monitor.scala:536:22
        d_first_counter_1 = _RANDOM[3'h3][9:1];	// src/main/scala/tilelink/Edges.scala:230:27
        watchdog = {_RANDOM[3'h3][31:10], _RANDOM[3'h4][9:0]};	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/Monitor.scala:706:27
        inflight_1 = _RANDOM[3'h4][10];	// src/main/scala/tilelink/Monitor.scala:706:27, :723:35
        inflight_opcodes_1 = _RANDOM[3'h4][14:11];	// src/main/scala/tilelink/Monitor.scala:706:27, :724:35
        inflight_sizes_1 = _RANDOM[3'h4][22:15];	// src/main/scala/tilelink/Monitor.scala:706:27, :725:35
        d_first_counter_2 = _RANDOM[3'h5][8:0];	// src/main/scala/tilelink/Edges.scala:230:27
        watchdog_1 = {_RANDOM[3'h5][31:9], _RANDOM[3'h6][8:0]};	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/Monitor.scala:815:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
