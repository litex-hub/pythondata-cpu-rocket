...
module AXI4Fragmenter_2(
  ...
  wire [28:0]      in_aw_bits_addr;	// src/main/scala/amba/axi4/Fragmenter.scala:62:23
  ...
  wire [28:0]      in_ar_bits_addr;	// src/main/scala/amba/axi4/Fragmenter.scala:62:23
  ...
  wire [28:0]      irr_bits_addr;	// src/main/scala/chisel3/util/Decoupled.scala:415:19
  wire [28:0]      addr = busy ? r_addr : irr_bits_addr;	// src/main/scala/amba/axi4/Fragmenter.scala:64:29, :65:25, :69:23, src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  wire [28:0]      inc_addr = addr + {13'h0, 16'h1 << irr_bits_size};	// src/main/scala/amba/axi4/Fragmenter.scala:69:23, :104:{29,38}, src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  wire [28:0]      _mux_addr_T_1 = ~irr_bits_addr;	// src/main/scala/amba/axi4/Fragmenter.scala:108:49, src/main/scala/chisel3/util/Decoupled.scala:415:19
  wire [28:0]      mux_addr =
    fixed
      ? irr_bits_addr
      : irr_bits_burst == 2'h2
  ...
  assign in_ar_bits_addr =
    ~{_out_bits_addr_T[28:3], _out_bits_addr_T[2:0] | ~(_out_bits_addr_T_2[2:0])};	// src/main/scala/amba/axi4/Fragmenter.scala:62:23, :126:{26,28,34}, src/main/scala/util/package.scala:235:{46,71,76}
  ...
  wire [28:0]      irr_1_bits_addr;	// src/main/scala/chisel3/util/Decoupled.scala:415:19
  wire [28:0]      addr_1 = busy_1 ? r_addr_1 : irr_1_bits_addr;	// src/main/scala/amba/axi4/Fragmenter.scala:64:29, :65:25, :69:23, src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  wire [28:0]      inc_addr_1 = addr_1 + {13'h0, 16'h1 << irr_1_bits_size};	// src/main/scala/amba/axi4/Fragmenter.scala:69:23, :104:{29,38}, src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  wire [28:0]      _mux_addr_T_6 = ~irr_1_bits_addr;	// src/main/scala/amba/axi4/Fragmenter.scala:108:49, src/main/scala/chisel3/util/Decoupled.scala:415:19
  ...
  assign in_aw_bits_addr =
    ~{_out_bits_addr_T_7[28:3], _out_bits_addr_T_7[2:0] | ~(_out_bits_addr_T_9[2:0])};	// src/main/scala/amba/axi4/Fragmenter.scala:62:23, :126:{26,28,34}, src/main/scala/util/package.scala:235:{46,71,76}
  ...
  Queue_116 deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_116 deq_q_1 (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock             (clock),
    .reset             (reset),
  ...
  Queue_43 in_w_deq_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
