  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        a_first_counter = _RANDOM[/*Zero width*/ 1'b0][0];	// src/main/scala/tilelink/Edges.scala:230:27
        d_first_counter = _RANDOM[/*Zero width*/ 1'b0][1];	// src/main/scala/tilelink/Edges.scala:230:27
        flight_0 = _RANDOM[/*Zero width*/ 1'b0][2];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_1 = _RANDOM[/*Zero width*/ 1'b0][3];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_2 = _RANDOM[/*Zero width*/ 1'b0][4];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_3 = _RANDOM[/*Zero width*/ 1'b0][5];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_4 = _RANDOM[/*Zero width*/ 1'b0][6];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_5 = _RANDOM[/*Zero width*/ 1'b0][7];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_6 = _RANDOM[/*Zero width*/ 1'b0][8];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_7 = _RANDOM[/*Zero width*/ 1'b0][9];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_8 = _RANDOM[/*Zero width*/ 1'b0][10];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:73:27
        flight_9 = _RANDOM[/*Zero width*/ 1'b0][11];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:73:27
        SourceIdFIFOed = _RANDOM[/*Zero width*/ 1'b0][21:12];	// src/main/scala/tilelink/Edges.scala:230:27, src/main/scala/tilelink/FIFOFixer.scala:109:35
      `endif // RANDOMIZE_REG_INIT
    end // initial
