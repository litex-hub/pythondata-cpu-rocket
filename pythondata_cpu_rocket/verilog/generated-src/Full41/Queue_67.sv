...
module Queue_67(
  ...
  reg  [115:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]   io_deq_bits_opcode_0 = ram[2:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]   io_deq_bits_param_0 = ram[5:3];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [1:0]   io_deq_bits_size_0 = ram[7:6];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [8:0]   io_deq_bits_source_0 = ram[16:8];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [25:0]  io_deq_bits_address_0 = ram[42:17];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]   io_deq_bits_mask_0 = ram[50:43];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0]  io_deq_bits_data_0 = ram[114:51];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire         io_deq_bits_corrupt_0 = ram[115];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][20:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
