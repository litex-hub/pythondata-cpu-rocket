...
module Queue_103(
  ...
  wire [2:0]  io_enq_bits_sink_0 = io_enq_bits_sink;
  ...
  reg  [81:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [2:0]  io_deq_bits_opcode_0 = empty ? io_enq_bits_opcode_0 : ram[2:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [1:0]  io_deq_bits_param_0 = empty ? io_enq_bits_param_0 : ram[4:3];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [2:0]  io_deq_bits_size_0 = empty ? io_enq_bits_size_0 : ram[7:5];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [4:0]  io_deq_bits_source_0 = empty ? io_enq_bits_source_0 : ram[12:8];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [2:0]  io_deq_bits_sink_0 = empty ? io_enq_bits_sink_0 : ram[15:13];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire        io_deq_bits_denied_0 = empty ? io_enq_bits_denied_0 : ram[16];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [63:0] io_deq_bits_data_0 = empty ? io_enq_bits_data_0 : ram[80:17];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire        io_deq_bits_corrupt_0 = empty ? io_enq_bits_corrupt_0 : ram[81];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire        do_deq = ~empty & io_deq_ready_0 & io_deq_valid_0;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, :279:25, :282:27, :316:17, :318:14
  wire        do_enq = ~(empty & io_deq_ready_0) & io_enq_ready_0 & io_enq_valid_0;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, :279:25, :281:27, :316:17, :319:{26,35}
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][18:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
