...
module TLBroadcastTracker(
  ...
  wire [3:0]   io_probe_bits_cacheOH = 4'hF;
  ...
  wire         probe_done = count == 3'h0;	// src/main/scala/tilelink/Broadcast.scala:434:20, :469:19, :491:26
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_0)	// src/main/scala/tilelink/Broadcast.scala:468:22
      ...
      count <= 3'h1;	// src/main/scala/tilelink/Broadcast.scala:434:20
    if (io_probe_valid_0)
      cacheOH <= 4'hF;	// src/main/scala/tilelink/Broadcast.scala:435:20
    else
