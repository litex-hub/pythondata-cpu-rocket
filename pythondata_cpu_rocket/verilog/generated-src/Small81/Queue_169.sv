...
module Queue_169(
  ...
  input  [28:0] io_enq_bits_addr,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [28:0] io_deq_bits_addr,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  wire [28:0] io_enq_bits_addr_0 = io_enq_bits_addr;
  ...
  reg  [57:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [28:0] io_deq_bits_addr_0 = empty ? io_enq_bits_addr_0 : ram[32:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][26:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
