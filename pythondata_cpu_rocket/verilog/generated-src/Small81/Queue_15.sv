...
module Queue_15(
  ...
  reg  [10:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_tl_state_size_0 = ram[3:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [5:0]  io_deq_bits_tl_state_source_0 = ram[9:4];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_extra_id_0 = ram[10];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = _RANDOM[/*Zero width*/ 1'b0][11:1];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
