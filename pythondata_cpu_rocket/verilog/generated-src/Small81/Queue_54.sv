...
module Queue_54(
  ...
  wire [4:0]  io_enq_bits_id_0 = io_enq_bits_id;
  ...
  wire [4:0]  io_deq_bits_id_0 = ram[4:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [30:0] io_deq_bits_addr_0 = ram[35:5];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [5:0]  io_deq_bits_echo_tl_state_source_0 = ram[70:65];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_wen_0 = ram[71];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
