...
module Queue_106(
  ...
  input  [7:0]  io_enq_bits_id,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  input  [7:0]  io_enq_bits_echo_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [7:0]  io_deq_bits_id,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [7:0]  io_deq_bits_echo_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  output        io_deq_bits_wen	// src/main/scala/chisel3/util/Decoupled.scala:273:14
);

  wire        io_enq_valid_0 = io_enq_valid;
  wire [7:0]  io_enq_bits_id_0 = io_enq_bits_id;
  ...
  wire [7:0]  io_enq_bits_echo_tl_state_source_0 = io_enq_bits_echo_tl_state_source;
  ...
  reg  [77:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]  io_deq_bits_id_0 = ram[7:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [31:0] io_deq_bits_addr_0 = ram[39:8];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]  io_deq_bits_len_0 = ram[47:40];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]  io_deq_bits_size_0 = ram[50:48];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [1:0]  io_deq_bits_burst_0 = ram[52:51];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_lock_0 = ram[53];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_cache_0 = ram[57:54];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]  io_deq_bits_prot_0 = ram[60:58];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_qos_0 = ram[64:61];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_echo_tl_state_size_0 = ram[68:65];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]  io_deq_bits_echo_tl_state_source_0 = ram[76:69];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_wen_0 = ram[77];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][14:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
