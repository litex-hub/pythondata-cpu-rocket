...
module Queue_151(
  ...
  wire [9:0]   io_enq_bits_extra_tlrr_extra_source_0 =
  ...
  reg  [107:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [9:0]   io_deq_bits_extra_tlrr_extra_source_0 = ram[105:96];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [1:0]   io_deq_bits_extra_tlrr_extra_size_0 = ram[107:106];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][12:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
