...
module SinkA(
  ...
  output [5:0]  io_req_bits_source,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14
  ...
  input  [5:0]  io_a_bits_source,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14
  ...
  wire [5:0]  io_a_bits_source_0 = io_a_bits_source;
  ...
  wire [5:0]  io_req_bits_source_0 = io_a_bits_source_0;
  ...
  wire        free = lists != 40'hFFFFFFFFFF;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:52:22, :58:{14,21}
  ...
  wire [2:0]  first_beats1 = first_beats1_opdata ? first_beats1_decode : 3'h0;	// src/main/scala/tilelink/Edges.scala:93:28, :221:59, :222:14
  ...
  wire        set_block = hasData & first & ~free;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:58:14, :72:{27,36,39}, src/main/scala/tilelink/Edges.scala:93:28, :232:25
  assign io_a_ready_0 = ~req_block & ~buf_block & ~set_block;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:70:25, :71:27, :72:36, :78:{14,25,28,39,42}
  ...
  wire        io_req_valid_0 = _io_req_valid_T & ~buf_block & ~set_block;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:71:27, :72:36, :78:{28,42}, :79:{27,36,50}
  wire [39:0] lists_set =
    _io_req_valid_T & hasData & ~req_block & ~buf_block ? freeOH[39:0] : 40'h0;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:54:27, :59:39, :70:25, :71:27, :78:{14,28}, :79:27, :81:{26,37,51,66,78}, src/main/scala/tilelink/Edges.scala:93:28
  ...
  wire        putbuffer_io_pop_valid = io_pb_pop_ready_0 & io_pb_pop_valid_0;	// src/main/scala/chisel3/util/Decoupled.scala:52:35
  ...
  wire [39:0] lists_clr =
    putbuffer_io_pop_valid & io_pb_pop_bits_last_0 ? _lists_clr_T[39:0] : 40'h0;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/chisel3/util/OneHot.scala:65:{12,27}, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:55:27, :108:{24,48}, :109:15
  ...
  ListBuffer putbuffer (	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:51:25
    ...
    .io_push_valid             (io_a_valid_0 & hasData & ~req_block & ~set_block),	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:70:25, :72:36, :78:{14,42}, :80:{38,49,63}, src/main/scala/tilelink/Edges.scala:93:28
  ...
  );	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:51:25
