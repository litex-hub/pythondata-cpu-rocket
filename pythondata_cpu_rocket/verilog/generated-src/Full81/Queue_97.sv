...
module Queue_97(
  ...
  wire [9:0]  io_enq_bits_extra_tlrr_extra_source_0 = io_enq_bits_extra_tlrr_extra_source;
  ...
  reg  [93:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [9:0]  io_deq_bits_extra_tlrr_extra_source_0 = ram[91:82];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [1:0]  io_deq_bits_extra_tlrr_extra_size_0 = ram[93:92];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][30:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
