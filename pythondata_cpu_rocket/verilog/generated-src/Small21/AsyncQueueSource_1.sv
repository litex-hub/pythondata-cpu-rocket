  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_hrmask_0 = _RANDOM[/*Zero width*/ 1'b0][15];	// src/main/scala/util/AsyncQueue.scala:80:16
        mem_0_hrmask_1 = _RANDOM[/*Zero width*/ 1'b0][16];	// src/main/scala/util/AsyncQueue.scala:80:16
        widx_widx_bin = _RANDOM[/*Zero width*/ 1'b0][17];	// src/main/scala/util/AsyncQueue.scala:52:25, :80:16
        ready_reg = _RANDOM[/*Zero width*/ 1'b0][18];	// src/main/scala/util/AsyncQueue.scala:80:16, :88:56
        widx_gray = _RANDOM[/*Zero width*/ 1'b0][19];	// src/main/scala/util/AsyncQueue.scala:80:16, :91:55
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        widx_widx_bin = 1'h0;	// src/main/scala/util/AsyncQueue.scala:52:25
        ready_reg = 1'h0;	// src/main/scala/util/AsyncQueue.scala:88:56
