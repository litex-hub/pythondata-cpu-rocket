...
module Queue_64(
  ...
  wire [8:0]  io_enq_bits_index_0 = io_enq_bits_index;
  wire [63:0] io_enq_bits_data_0 = io_enq_bits_data;
  wire [7:0]  io_enq_bits_mask_0 = io_enq_bits_mask;
  wire [8:0]  io_enq_bits_extra_tlrr_extra_source_0 = io_enq_bits_extra_tlrr_extra_source;
  ...
  reg  [92:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_read_0 = ram[0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [8:0]  io_deq_bits_index_0 = ram[9:1];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [63:0] io_deq_bits_data = ram[73:10];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]  io_deq_bits_mask_0 = ram[81:74];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [8:0]  io_deq_bits_extra_tlrr_extra_source_0 = ram[90:82];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [1:0]  io_deq_bits_extra_tlrr_extra_size_0 = ram[92:91];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][29:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
