...
module SinkC(
  ...
  output [4:0]  io_req_bits_source,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14
  ...
  output [4:0]  io_resp_bits_source,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14
  ...
  input  [4:0]  io_c_bits_source,	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14
  ...
  wire        io_c_ready_0;
  wire        c_q_io_deq_ready;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:134:19
  wire [9:0]  io_set_0;
  ...
  wire [4:0]  _c_q_io_deq_bits_source;	// src/main/scala/chisel3/util/Decoupled.scala:376:21
  ...
  wire [4:0]  io_c_bits_source_0 = io_c_bits_source;
  ...
  wire        io_req_bits_prio_2 = 1'h1;
  wire        bs_adr_bits_mask = 1'h1;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:96:22
  wire        io_req_bits_prio_0 = 1'h0;
  ...
  wire        _GEN = c_q_io_deq_ready & _c_q_io_deq_valid;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, :376:21, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:134:19
  ...
  wire [2:0]  beats1 = beats1_opdata ? beats1_decode : 3'h0;	// src/main/scala/tilelink/Edges.scala:103:36, :221:59, :222:14
  ...
  `ifndef SYNTHESIS	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:90:12
    always @(posedge clock) begin	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:90:12
      if (~reset & _c_q_io_deq_valid & _c_q_io_deq_bits_corrupt) begin	// src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:90:{12,23}
  ...
  wire        io_resp_valid_0 =
    resp & _c_q_io_deq_valid & (first | last) & (~hasData | bs_adr_ready);	// src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:79:19, :96:22, :107:{27,38,48,57,61,70}, src/main/scala/tilelink/Edges.scala:103:36, :232:25, :233:33
  ...
  wire [2:0]  freeOH = {1'h0, {~(_freeOH_T_7[0]), 1'h1} & _freeOH_T_7};	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:123:{18,27,41}
  ...
  wire        set_block = hasData & first & ~free;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:122:16, :128:{29,38,41}, src/main/scala/tilelink/Edges.scala:103:36, :232:25
  assign c_q_io_deq_ready =
    raw_resp ? ~hasData | bs_adr_ready : ~req_block & ~buf_block & ~set_block;	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:78:58, :96:22, :107:61, :126:27, :127:29, :128:38, :134:{19,39,56,67,70,81,84}, src/main/scala/tilelink/Edges.scala:103:36
  wire        io_req_valid_0 =
    ~resp & _c_q_io_deq_valid & first & ~buf_block & ~set_block;	// src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:79:19, :127:29, :128:38, :134:{70,84}, :136:{21,27,38,47,61}, src/main/scala/tilelink/Edges.scala:232:25
  wire [1:0]  lists_set =
    ~resp & _c_q_io_deq_valid & first & hasData & ~req_block & ~buf_block
      ? freeIdx_lo
      : 2'h0;	// src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/chisel3/util/OneHot.scala:31:18, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:79:19, :118:29, :126:27, :127:29, :134:{56,70}, :136:21, :138:{17,28,37,48,62,77,89}, src/main/scala/tilelink/Edges.scala:103:36, :232:25
  ...
  wire        putbuffer_io_pop_valid = io_rel_pop_ready_0 & io_rel_pop_valid_0;	// src/main/scala/chisel3/util/Decoupled.scala:52:35
  ...
  wire [1:0]  lists_clr =
    putbuffer_io_pop_valid & io_rel_pop_bits_last_0
  ...
  Queue_70 c_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock               (clock),
    .reset               (reset),
    ...
    .io_deq_ready        (c_q_io_deq_ready),	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:134:19
  ...
  Queue_71 io_bs_adr_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
  ...
  ListBuffer_1 putbuffer (	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:115:27
    ...
    .io_push_valid
      (~resp & _c_q_io_deq_valid & hasData & ~req_block & ~set_block),	// src/main/scala/chisel3/util/Decoupled.scala:376:21, src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:79:19, :126:27, :128:38, :134:{56,84}, :136:21, :137:{38,49,60,74}, src/main/scala/tilelink/Edges.scala:103:36
    ...
    .io_pop_valid              (putbuffer_io_pop_valid),	// src/main/scala/chisel3/util/Decoupled.scala:52:35
  ...
  );	// src/main/scala/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:115:27
