...
module FPU(
  input         clock,
                reset,
  input  [1:0]  io_hartid,	// src/main/scala/tile/FPU.scala:727:14
  ...
  wire [63:0]      _GEN = {62'h0, io_hartid_0};	// src/main/scala/tile/FPU.scala:785:14
  ...
  wire [63:0]      _wdata_T_2 =
    (wdata_truncIdx ? 64'h0 : 64'hFFFFFFFF00000000) | load_wb_data;	// src/main/scala/tile/FPU.scala:425:23, :751:31, src/main/scala/util/package.scala:32:47, :33:76
  ...
  wire [11:0]      sfma_io_in_bits_req_in1_expOut_commonCase =
    sfma_io_in_bits_req_in1_expIn - 12'h700;	// src/main/scala/tile/FPU.scala:270:18, :274:{31,50}
  ...
  wire [11:0]      sfma_io_in_bits_req_in2_expOut_commonCase =
    sfma_io_in_bits_req_in2_expIn - 12'h700;	// src/main/scala/tile/FPU.scala:270:18, :274:{31,50}
  ...
  wire [11:0]      sfma_io_in_bits_req_in3_expOut_commonCase =
    sfma_io_in_bits_req_in3_expIn - 12'h700;	// src/main/scala/tile/FPU.scala:270:18, :274:{31,50}
  ...
  wire             mem_wen =
    mem_reg_valid & (mem_ctrl_fma | mem_ctrl_fastpipe | mem_ctrl_fromint);	// src/main/scala/tile/FPU.scala:760:30, :777:27, :912:{31,48,69}
  ...
  wire [53:0]      frfWriteBundle_1_wrdata_unrecoded_rawIn_sig =
    {1'h0, ~frfWriteBundle_1_wrdata_unrecoded_rawIn_isZero, wdata_1[51:0]};	// hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:52:53, :55:23, :61:{35,44,49}, src/main/scala/util/package.scala:33:76
  ...
  wire [64:0]      io_cp_resp_bits_data = io_cp_resp_valid ? wdata_1 : 65'h0;	// src/main/scala/tile/FPU.scala:853:60, :952:33, :953:26, src/main/scala/util/package.scala:33:76
  ...
  wire             io_fcsr_flags_valid_0 = wb_toint_valid | divSqrt_wen | wen[0];	// src/main/scala/tile/FPU.scala:868:32, :910:20, :938:30, :958:37, :960:{41,56}
  ...
  wire [4:0]       io_fcsr_flags_bits_0 =
    ...
    | (wen[0] ? wexc : 5'h0);	// src/main/scala/tile/FPU.scala:868:32, :873:27, :910:20, :938:30, :958:37, :959:31, :962:{8,44}, :963:{8,42}, :964:8, src/main/scala/util/package.scala:33:76
  ...
  wire             io_fcsr_rdy_0 =
    ~(ex_reg_valid & ex_ctrl_wflags | mem_reg_valid & mem_ctrl_wflags | wb_toint_valid
      | (|wen) | divSqrt_inFlight);	// src/main/scala/tile/FPU.scala:743:29, :760:30, :776:20, :777:27, :869:37, :910:20, :958:37, :966:72, :967:{18,33,51,68,87,120,131}
  assign io_nack_mem_0 = write_port_busy | divSqrt_write_port_busy | divSqrt_inFlight;	// src/main/scala/tile/FPU.scala:869:37, :913:34, :966:65, :968:{34,61}
  ...
  wire             io_illegal_rm_0 =
    ...
    & io_fcsr_rm_0 > 3'h4;	// src/main/scala/tile/FPU.scala:976:{27,53,71,79,93}, src/main/scala/util/package.scala:16:47, :73:59
  wire             divSqrt_inValid =
    mem_reg_valid & _divSqrt_inValid_T & ~divSqrt_inFlight;	// src/main/scala/tile/FPU.scala:760:30, :869:37, :966:47, :979:{41,76,79}
  ...
  wire [11:0]      divSqrt_io_a_expOut_commonCase = divSqrt_io_a_expIn - 12'h700;	// src/main/scala/tile/FPU.scala:270:18, :274:{31,50}
  ...
  wire [11:0]      divSqrt_io_b_expOut_commonCase = divSqrt_io_b_expIn - 12'h700;	// src/main/scala/tile/FPU.scala:270:18, :274:{31,50}
  ...
  always @(posedge clock) begin
    automatic logic _GEN_8;	// src/main/scala/tile/FPU.scala:917:21, :920:18, :925:{30,52}, :926:22
    automatic logic _GEN_9;	// src/main/scala/tile/FPU.scala:917:21, :920:18, :925:{30,52}, :926:22
    automatic logic _GEN_10;	// src/main/scala/tile/FPU.scala:911:19, :920:18, :925:{30,52}, :926:22
    _GEN_8 = mem_wen & ~write_port_busy & memLatencyMask[0];	// src/main/scala/tile/FPU.scala:897:72, :912:31, :913:34, :917:21, :920:18, :925:{13,30,47,52}, :926:22
    _GEN_9 = mem_wen & ~write_port_busy & memLatencyMask[1];	// src/main/scala/tile/FPU.scala:897:72, :912:31, :913:34, :917:21, :920:18, :925:{13,30,47,52}, :926:22
    _GEN_10 = mem_wen & ~write_port_busy & memLatencyMask[2];	// src/main/scala/tile/FPU.scala:897:72, :911:19, :912:31, :913:34, :920:18, :925:{13,30,47,52}, :926:22
    if (reset) begin
    ...
    if (io_valid_0) begin
      ...
      if (_fp_decoder_io_sigs_ren2 & ~_fp_decoder_io_sigs_swap12
          & ~_fp_decoder_io_sigs_swap23)	// src/main/scala/tile/FPU.scala:739:26, :810:25, :811:13, :814:25, :817:{29,32,49,60}
    ...
    if (_GEN_8) begin	// src/main/scala/tile/FPU.scala:917:21, :920:18, :925:{30,52}, :926:22
    ...
    wbInfo_0_cp <= ~_GEN_8 & (wen[1] ? wbInfo_1_cp : wbInfo_0_cp);	// src/main/scala/tile/FPU.scala:910:20, :911:19, :917:{14,21,33}, :920:18, :925:{30,52}, :926:22
    if (_GEN_9) begin	// src/main/scala/tile/FPU.scala:917:21, :920:18, :925:{30,52}, :926:22
    ...
    wbInfo_1_cp <= ~_GEN_9 & (wen[2] ? wbInfo_2_cp : wbInfo_1_cp);	// src/main/scala/tile/FPU.scala:910:20, :911:19, :917:{21,33}, :920:18, :925:{30,52}, :926:22
    if (_GEN_10) begin	// src/main/scala/tile/FPU.scala:911:19, :920:18, :925:{30,52}, :926:22
    ...
    wbInfo_2_cp <= ~_GEN_10 & wbInfo_2_cp;	// src/main/scala/tile/FPU.scala:911:19, :920:18, :925:{30,52}, :926:22
    ...
    io_sboard_set_REG <=
      mem_ctrl_fma & _divSqrt_io_inValid_T_2 | mem_ctrl_div | mem_ctrl_sqrt;	// src/main/scala/tile/FPU.scala:777:27, :887:{62,78}, :971:{59,95,111}
  end // always @(posedge)
  ...
  );	// src/main/scala/tile/FPU.scala:739:26
  wire             io_dec_ldst_0;
  ...
  );	// src/main/scala/tile/FPU.scala:794:20
  ...
  );	// src/main/scala/tile/FPU.scala:844:20
  FPToInt fpiu (	// src/main/scala/tile/FPU.scala:848:20
    .clock                 (clock),
    .io_in_valid
      (req_valid
       & (ex_ctrl_toint | ex_ctrl_div | ex_ctrl_sqrt | ex_ctrl_fastpipe
          & ex_ctrl_wflags)),	// src/main/scala/tile/FPU.scala:756:32, :776:20, :849:{33,51,66,82,103}
  ...
  );	// src/main/scala/tile/FPU.scala:848:20
  ...
  );	// src/main/scala/tile/FPU.scala:858:20
  ...
  );	// src/main/scala/tile/FPU.scala:863:20
  ...
  );	// src/main/scala/tile/FPU.scala:884:28
  ...
  );	// src/main/scala/tile/FPU.scala:991:55
