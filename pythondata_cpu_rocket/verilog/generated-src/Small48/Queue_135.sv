...
module Queue_135(
  ...
  input  [63:0]  io_enq_bits_strb,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [63:0]  io_deq_bits_strb,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  wire [63:0]  io_enq_bits_strb_0 = io_enq_bits_strb;
  ...
  reg  [576:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  wire [511:0] io_deq_bits_data_0 = empty ? io_enq_bits_data_0 : ram[511:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire [63:0]  io_deq_bits_strb_0 = empty ? io_enq_bits_strb_0 : ram[575:512];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
  wire         io_deq_bits_last_0 = empty ? io_enq_bits_last_0 : ram[576];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :279:25, :311:17, :316:17, :317:19
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram =
          {_RANDOM[5'h0][31:1],
           ...
           _RANDOM[5'h10],
           _RANDOM[5'h11],
           _RANDOM[5'h12][1:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
        maybe_full = _RANDOM[5'h0][0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95, :277:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
